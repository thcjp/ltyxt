...
export const useCourseStore = defineStore('course', () => {
  ...
  const courseMetas = ref<CourseMeta[]>([
    ...
    { subject: 'math', grade: 4, title: '四年级数学', subtitle: '大数·角的度量·运算定律', icon: '🔢', color: '#2ECC71', totalUnits: 8 },
    { subject: 'math', grade: 5, title: '五年级数学', subtitle: '小数·方程·多边形面积', icon: '🔢', color: '#2ECC71', totalUnits: 8 },
    { subject: 'math', grade: 6, title: '六年级数学', subtitle: '分数·比·圆·百分数', icon: '🔢', color: '#2ECC71', totalUnits: 8 },
    ...
    { subject: 'english', grade: 5, title: '五年级英语', subtitle: 'Teachers·Week·Food·Room', icon: '🌟', color: '#E74C3C', totalUnits: 8 },
    { subject: 'english', grade: 6, title: '六年级英语', subtitle: 'Transport·Museum·Hobbies·Jobs', icon: '🌟', color: '#E74C3C', totalUnits: 8 },
  ])
