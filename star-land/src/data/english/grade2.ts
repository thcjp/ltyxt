    ...
    lessons: [
      {
        ...
        parentTips: '每天早上可以和孩子一起用英语说正在做的事情',
        ...
        content: [
          ...
          { type: 'animation', content: '太阳升起，时钟转动，小朋友起床做早晨日常的动画', animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u1l1q1',
      ...
      },
      {
        ...
        parentTips: '放学后可以问孩子"今天在学校做了什么？"鼓励用英语回答',
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'animation', content: '月亮升起，星星闪烁，小朋友做晚间日常的动画', animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u1l3q1',
...
频率词：every day每天`, animationType: 'typewriter', label: 'My Day公式' },
          { type: 'animation', content: `My Day单元回顾动画`, animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u1l4q1',
    ...
    lessons: [
      {
        ...
        content: [
          ...
          { type: 'animation', content: '太阳、雨滴、云朵、雪花依次出现的天气动画', animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u2l1q1',
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'animation', content: '四季轮转动画，每个季节展示对应景色', animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u2l2q1',
...
I wear + 服装 → I wear a coat.`, animationType: 'typewriter', label: 'Weather公式' },
          { type: 'animation', content: `Weather单元回顾动画`, animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u2l4q1',
    ...
    lessons: [
      {
        ...
        content: [
          ...
          { type: 'animation', content: '房门依次打开，展示每个房间内部的动画', animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u3l1q1',
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'animation', content: '购物车滑动，商品扫描的超市购物动画', animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u3l3q1',
...
I buy + 物品 → I buy apples.`, animationType: 'typewriter', label: 'Places公式' },
          { type: 'animation', content: `Places单元回顾动画`, animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u3l4q1',
    ...
    lessons: [
      {
        ...
        content: [
          ...
          { type: 'animation', content: '小人做跑步、跳跃、游泳、跳舞的动画', animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u4l1q1',
      ...
      },
      {
        ...
        parentTips: '鼓励孩子大胆说，can\'t的内容可以有趣一些',
      ...
      },
      {
        ...
        parentTips: '现在进行时=am/is/are + 动词ing，表示正在做',
        ...
        content: [
          ...
          { type: 'animation', content: '动作进行中指示器，ing后缀弹入的动画', animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u4l3q1',
...
现在进行时：I am + 动词ing → I am running.`, animationType: 'typewriter', label: 'Actions公式' },
          { type: 'animation', content: `Actions单元回顾动画`, animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u4l4q1',
    ...
    lessons: [
      {
        ...
        parentTips: '整理衣柜和搭配衣服时都可以练习服装英语',
      ...
      },
      {
        ...
        parentTips: '购物对话是实用的生活英语，多练习会很有帮助',
        ...
        content: [
          ...
          { type: 'animation', content: '价格标签弹出，购物袋晃动的服装店动画', animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u5l3q1',
...
购物：Can I help you? → I want a...`, animationType: 'typewriter', label: 'Clothes公式' },
          { type: 'animation', content: `Clothes单元回顾动画`, animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u5l4q1',
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        parentTips: '过马路时用英语说交通规则，安全又学英语',
        ...
        content: [
          ...
          { type: 'animation', content: '红绿灯切换动画，行人过马路的动画', animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u6l3q1',
...
Red light, stop! / Green light, go!`, animationType: 'typewriter', label: 'Transport公式' },
          { type: 'animation', content: `Transport单元回顾动画`, animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u6l4q1',
    ...
    lessons: [
      {
        ...
        parentTips: '鼓励孩子说出真实的爱好，不要替孩子决定',
        ...
        content: [
          ...
          { type: 'animation', content: '爱好图标依次弹出，爱心飘浮的动画', animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u7l1q1',
      ...
      },
      {
        ...
        parentTips: 'like + 名词表示喜欢某物，like + doing表示喜欢做某事',
      ...
      },
      {
        ...
        parentTips: '周末前用英语讨论计划，周末后用英语回顾',
        ...
        content: [
          ...
          { type: 'animation', content: '日历翻页动画，周末日期高亮的动画', animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u7l3q1',
...
周末：On Saturday, I will...`, animationType: 'typewriter', label: 'Hobbies公式' },
          { type: 'animation', content: `Hobbies单元回顾动画`, animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u7l4q1',
    ...
    lessons: [
      {
        ...
        content: [
          ...
          { type: 'animation', content: '烟花绽放、灯笼摇曳的节日动画', animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u8l1q1',
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'animation', content: '圣诞树装饰、礼物打开的动画', animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u8l2q1',
      ...
      },
      {
        ...
        parentTips: '让孩子为中国节日感到自豪，用英语传播中国文化',
        ...
        content: [
          ...
          { type: 'animation', content: '春联展开、红包打开的中国节日动画', animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u8l3q1',
...
Happy Spring Festival! / We eat dumplings.`, animationType: 'typewriter', label: 'Festival公式' },
          { type: 'animation', content: `Festival单元回顾动画`, animationType: 'bounce' },
        ],
        practiceQuestions: [
          {
            id: 'e2u8l4q1',
