    ...
    lessons: [
      {
        ...
        parentTips: '用夸张的表情和动作演绎性格词汇，让孩子在笑声中记住单词含义',
      ...
      },
      {
        ...
        parentTips: '可以用家里的课程表来练习，指着科目问孩子Who is your...teacher?',
      ...
      },
      {
        ...
        parentTips: '可以画老师的简笔画，一边画一边描述，帮助记忆外貌词汇',
      ...
      },
      {
        ...
        parentTips: '老师卡内容包括：科目+姓名+外貌+性格，鼓励孩子用完整句子描述',
      ...
      },
      {
        ...
        parentTips: '词汇+句型+描述综合检测，正确率≥80%为通关',
    ...
    lessons: [
      {
        ...
        parentTips: '用歌曲学星期词汇，节奏感帮助记忆，可以在日历上标注英语星期名',
      ...
      },
      {
        ...
        parentTips: '每天早上可以问孩子What day is it today?让孩子养成用英语说星期的习惯',
      ...
      },
      {
        ...
        parentTips: '用课程表学课程词汇，把家里课程表翻译成英文版',
      ...
      },
      {
        ...
        parentTips: 'What do you have on Mondays? We have English and maths. 用复数问每周的习惯',
      ...
      },
      {
        ...
        parentTips: '星期+课程+句型综合检测，正确率≥80%为通关',
    ...
    lessons: [
      {
        ...
        parentTips: '用食物图片学单词，可以在吃饭时复习食物词汇',
      ...
      },
      {
        ...
        parentTips: 'What\'s your favourite food? I like fish. 用I like回答最喜欢的食物',
      ...
      },
      {
        ...
        parentTips: 'I like fish. I don\'t like onions. 用don\'t like表示不喜欢',
      ...
      },
      {
        ...
        parentTips: '食物金字塔：谷物/蔬菜/水果/肉类/油脂，多吃谷物蔬菜水果，少吃油脂',
      ...
      },
      {
        ...
        parentTips: '食物+喜好+句型综合检测，正确率≥80%为通关',
    ...
    lessons: [
      {
        ...
        parentTips: '边做动作边学才艺词汇，身体记忆帮助加深印象',
      ...
      },
      {
        ...
        parentTips: 'I can... = 我会... can后面加动词原形',
      ...
      },
      {
        ...
        parentTips: 'Can you swim? Yes, I can. / No, I can\'t. can\'t = cannot',
      ...
      },
      {
        ...
        parentTips: '用英语介绍并展示一项才艺，鼓励孩子自信展示',
      ...
      },
      {
        ...
        parentTips: '才艺+能力+句型综合检测，正确率≥80%为通关',
    ...
    lessons: [
      {
        ...
        parentTips: '用房间图学家具词汇，可以在自己房间里指物说单词',
      ...
      },
      {
        ...
        parentTips: 'There is+单数，There are+复数。用实物演示帮助理解',
      ...
      },
      {
        ...
        parentTips: '用实物演示位置介词，把玩具放在不同位置让孩子描述',
      ...
      },
      {
        ...
        parentTips: '用There is/are和位置介词描述，鼓励孩子发挥想象',
      ...
      },
      {
        ...
        parentTips: '家具+句型+位置综合检测，正确率≥80%为通关',
    ...
    lessons: [
      {
        ...
        parentTips: '用公园图学自然景观词汇，可以在户外游玩时复习',
      ...
      },
      {
        ...
        parentTips: 'Is there a river? Yes, there is. Are there any fish? Yes, there are.',
      ...
      },
      {
        ...
        parentTips: '短文：This is a nature park. There is a river and a lake...',
      ...
      },
      {
        ...
        parentTips: 'We should protect nature. Don\'t litter. 用should和Don\'t表达环保建议',
      ...
      },
      {
        ...
        parentTips: '词汇+句型+阅读综合检测，正确率≥80%为通关',
    ...
    lessons: [
      {
        ...
        parentTips: '先预测再读，读后确认。培养主动阅读的习惯',
      ...
      },
      {
        ...
        parentTips: '细节题：在文中找答案；概括题：用自己的话说大意',
      ...
      },
      {
        ...
        parentTips: '叙事短文五要素：Who/When/Where/What/Why',
      ...
      },
      {
        ...
        parentTips: '说明短文：找特征和说明方法，用事实描述事物',
      ...
      },
      {
        ...
        parentTips: '2篇短文阅读理解，正确率≥75%为通关',
  ...
  // ==================== 第八单元：综合测评 ====================
  {
    ...
    lessons: [
      // --- Lesson 1: 词汇总复习 ---
      {
        ...
        parentTips: '用思维导图的方式帮孩子整理词汇，按主题分类记忆比死记硬背更有效',
      ...
      // --- Lesson 2: 句型总复习 ---
      {
        ...
        parentTips: '句型是英语的骨架，掌握句型比背单词更重要。鼓励孩子用每个句型说自己的真实情况',
      ...
      // --- Lesson 3: 阅读与写作总复习 ---
      {
        ...
        parentTips: '阅读时先通读了解大意，再带着问题找细节。写作时先想好要写什么，再逐句写出来',
      ...
      // --- Lesson 4: 对话与表达总复习 ---
      {
        ...
        parentTips: '对话练习要贴近真实生活，鼓励孩子用学过的句型表达真实想法，不怕说错',
      ...
      // --- Lesson 5: 学期综合测评 ---
      {
        ...
        parentTips: '测评不是考试而是检测，重点是发现薄弱环节。错了不可怕，弄懂为什么错最重要',
