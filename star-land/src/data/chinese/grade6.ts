    ...
    lessons: [
      {
        ...
        parentTips: '用三角形帮孩子直观理解议论三要素的关系，论点在顶端统领全局，论据在底部支撑。',
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u1l1q7',
            type: 'fill',
            question: '回顾本课知识：议论文三要素是论点、论据和___',
            answer: '论证',
            hint: '[议论文三要素]（语文六年级-第1单元）',
            explanation: '议论文三要素是论点、论据、论证。论证是用论据证明论点的过程。'
          }
        ]
      },
      {
        ...
        parentTips: '论点常在标题、开头或结尾，教孩子留意"我认为""总之"等标志性词语。',
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u1l2q7',
            type: 'fill',
            question: '回顾本课知识：找论点要留意"我认为""___"等标志性词语',
            answer: '总之',
            acceptableAnswers: ['总之', '可见', '综上所述'],
            hint: '[论点位置]（语文六年级-第1单元）',
            explanation: '找论点要留意"我认为""总之""可见""综上所述"等标志性词语，论点常紧跟其后。'
          }
        ]
      },
      {
        ...
        parentTips: '事实论据是例子/数据，道理论据是名言/原理。多让孩子举例练习辨析。',
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u1l3q7',
            type: 'fill',
            question: '回顾本课知识：论据分为事实论据和___论据',
            answer: '道理',
            hint: '[论据分类]（语文六年级-第1单元）',
            explanation: '论据分为事实论据（事例、数据、史实）和道理论据（名言、原理、公理）两大类。'
          }
        ]
      },
      {
        ...
        parentTips: '模板："我认为___，因为___，所以___"。先搭骨架再添血肉，写议论文就不难。',
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u1l4q7',
            type: 'fill',
            question: '回顾本课知识：议论模板是"我认为___，因为___，___"',
            answer: '所以',
            hint: '[议论模板]（语文六年级-第1单元）',
            explanation: '议论模板："我认为（论点），因为（论据），所以（结论）"。这是写简单议论文的基本骨架。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u1l5q7',
            type: 'fill',
            question: '回顾本单元知识：议论文三要素是论点、论据和___',
            answer: '论证',
            hint: '[议论文三要素]（语文六年级-第1单元）',
            explanation: '议论文三要素：论点（主张）、论据（理由证据）、论证（用论据证明论点的过程）。'
          }
        ]
      }
    ]
    ...
    lessons: [
      {
        ...
        parentTips: '人物+情节+环境是小说三要素。用思维导图帮孩子理清三者关系。',
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u2l1q7',
            type: 'fill',
            question: '回顾本课知识：小说三要素是人物、情节和___',
            answer: '环境',
            hint: '[小说三要素]（语文六年级-第2单元）',
            explanation: '小说三要素是人物（核心）、情节（骨架）、环境（背景）。'
          }
        ]
      },
      {
        ...
        parentTips: '从行为/语言/心理分析人物性格，用人物分析卡帮孩子梳理。',
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u2l2q7',
            type: 'fill',
            question: '回顾本课知识：分析人物性格要从外貌、语言、动作和___四个角度',
            answer: '心理',
            hint: '[人物分析]（语文六年级-第2单元）',
            explanation: '分析人物四角度：外貌、语言、动作、心理，综合判断人物性格。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u2l3q7',
            type: 'fill',
            question: '回顾本课知识：环境描写分为自然环境和___环境',
            answer: '社会',
            hint: '[环境描写分类]（语文六年级-第2单元）',
            explanation: '环境描写分为自然环境（天气、景色、季节）和社会环境（时代背景、社会风气）两类。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u2l4q7',
            type: 'fill',
            question: '回顾本课知识：小说情节四阶段是开端、发展、高潮和___',
            answer: '结局',
            hint: '[情节四阶段]（语文六年级-第2单元）',
            explanation: '小说情节四阶段：开端、发展、高潮、结局，构成完整的故事起伏。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u2l5q7',
            type: 'fill',
            question: '回顾本单元知识：小说三要素是人物、情节和___',
            answer: '环境',
            hint: '[小说三要素]（语文六年级-第2单元）',
    ...
    lessons: [
      {
        ...
        parentTips: '形散是材料自由，神聚是中心统一。用"散落的珍珠和串珠的线"帮孩子理解。',
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u3l1q7',
            type: 'fill',
            question: '回顾本课知识：散文最大的特点是___神聚',
            answer: '形散',
            hint: '[散文特点]（语文六年级-第3单元）',
      ...
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u3l2q7',
            type: 'fill',
            question: '回顾本课知识：散文语言的特点是优美和___',
            answer: '含蓄',
            hint: '[散文语言]（语文六年级-第3单元）',
            explanation: '散文语言优美（生动形象）又含蓄（言外有意），需要朗读细细品味。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u3l3q7',
            type: 'fill',
            question: '回顾本课知识：找情感线索要找___词、看情感变化、连成线索',
            answer: '情感',
            hint: '[情感线索]（语文六年级-第3单元）',
            explanation: '找情感线索三步：找情感词、看情感变化、连成线索。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u3l4q7',
            type: 'fill',
            question: '回顾本课知识：散文仿写要"神似"不要"___似"',
            answer: '形',
            hint: '[散文仿写]（语文六年级-第3单元）',
            explanation: '散文仿写要"神似"不要"形似"——学的是方法不是内容，用自己的感受去写。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u3l5q7',
            type: 'fill',
            question: '回顾本单元知识：散文最大的特点是___神聚',
            answer: '形散',
            hint: '[散文特点]（语文六年级-第3单元）',
            explanation: '散文最大的特点是"形散神聚"：形散（取材自由）神聚（中心统一）。'
          }
    ...
    lessons: [
      {
        ...
        parentTips: '放大镜法：聚焦一个特征细致描写。不要面面俱到，要抓住最有特点的地方。',
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u4l1q7',
            type: 'fill',
            question: '回顾本课知识：外貌细节描写用"___法"聚焦一个特征',
            answer: '放大镜',
            hint: '[外貌细节]（语文六年级-第4单元）',
            explanation: '外貌细节描写用"放大镜法"：聚焦一个最有特点的特征，细致描写。'
          }
        ]
      },
      {
        ...
        parentTips: '慢镜头法：把1秒的动作写成3句，分解动作让画面清晰。用好动词是关键。',
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u4l2q7',
            type: 'fill',
            question: '回顾本课知识：动作细节描写用"___法"把动作分解',
            answer: '慢镜头',
            hint: '[动作细节]（语文六年级-第4单元）',
            explanation: '动作细节描写用"慢镜头法"：把一个动作分解成几个小动作，像慢镜头一样写清楚。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u4l3q7',
            type: 'fill',
            question: '回顾本课知识：心理细节描写用"___法"写出心里想的话',
            answer: '内心独白',
            hint: '[心理细节]（语文六年级-第4单元）',
            explanation: '心理细节描写用"内心独白法"：写出人物心里想的话，让读者看到内心世界。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u4l4q7',
            type: 'fill',
            question: '回顾本课知识：环境细节描写用"___法"调动五种感官',
            answer: '五感',
            hint: '[环境细节]（语文六年级-第4单元）',
            explanation: '环境细节描写用"五感法"：调动视觉、听觉、嗅觉、味觉、触觉多角度描写环境。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u4l5q7',
            type: 'fill',
            question: '回顾本单元知识：外貌细节描写用"___法"聚焦一个特征',
            answer: '放大镜',
            hint: '[细节描写]（语文六年级-第4单元）',
            explanation: '外貌细节描写用"放大镜法"：聚焦一个最有特点的特征细致描写。'
          }
        ]
      }
    ]
    ...
    lessons: [
      {
        ...
        parentTips: '有些古诗蕴含人生哲理。先理解字面意思，再体会背后的道理。',
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u5l1q7',
            type: 'fill',
            question: '回顾本课知识："不识庐山真面目"蕴含的哲理是当局者迷，___清',
            answer: '旁观者',
            hint: '[古诗哲理]（语文六年级-第5单元）',
            explanation: '"不识庐山真面目，只缘身在此山中"哲理是：当局者迷，旁观者清。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u5l2q7',
            type: 'fill',
            question: '回顾本课知识：意境=画面+___',
            answer: '情感',
            hint: '[古诗意境]（语文六年级-第5单元）',
            explanation: '意境由画面（诗中景象）和情感（诗人感情）融合而成：意境=画面+情感。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u5l3q7',
            type: 'fill',
            question: '回顾本课知识：文言文中"走"的意思是___',
            answer: '跑',
            hint: '[文言文字词]（语文六年级-第5单元）',
      ...
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u5l4q7',
            type: 'fill',
            question: '回顾本课知识："欲穷千里目，更上一层楼"适合鼓励人___',
            answer: '上进',
            acceptableAnswers: ['上进', '进步', '不断进取'],
            hint: '[诗句运用]（语文六年级-第5单元）',
    ...
    lessons: [
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u6l1q7',
            type: 'fill',
            question: '回顾本课知识：成长故事要素包括时间、地点、人物、事件和___',
            answer: '感受',
            hint: '[成长故事]（语文六年级-第6单元）',
            explanation: '成长故事五要素：时间、地点、人物、事件、感受。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u6l2q7',
            type: 'fill',
            question: '回顾本课知识：书信格式中称呼要___格写加冒号',
            answer: '顶',
            hint: '[书信格式]（语文六年级-第6单元）',
            explanation: '书信格式：称呼顶格写加冒号，正文空两格写。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u6l3q7',
            type: 'fill',
            question: '回顾本课知识：毕业演讲三部分是回忆、感谢和___',
            answer: '展望',
            hint: '[毕业演讲]（语文六年级-第6单元）',
            explanation: '毕业演讲三部分：回忆、感谢、展望。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u6l4q7',
            type: 'fill',
            question: '回顾本课知识：小组合作三原则是明确分工、互相帮助和统一___',
            answer: '风格',
            hint: '[小组合作]（语文六年级-第6单元）',
            explanation: '小组合作三原则：明确分工、互相帮助、统一风格。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u6l5q7',
            type: 'fill',
            question: '回顾本单元知识：毕业演讲三部分是回忆、感谢和___',
            answer: '展望',
            hint: '[回忆与展望]（语文六年级-第6单元）',
            explanation: '毕业演讲三部分：回忆、感谢、展望。分享会上展示纪念册并发表演讲。'
          }
        ]
      }
    ]
    ...
    lessons: [
      {
        ...
        parentTips: '文言文：简洁/单音节词多/特殊句式。对比文言和白话帮孩子认识文言特点。',
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u7l1q7',
            type: 'fill',
            question: '回顾本课知识：文言文最突出的特点是___凝练',
            answer: '简洁',
            hint: '[文言文特点]（语文六年级-第7单元）',
      ...
      },
      {
        ...
        parentTips: '常见实词：曰/走/去/妻/子等。注意古今异义，记古义比今义。',
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u7l2q7',
            type: 'fill',
            question: '回顾本课知识：文言文中"走"的古义是___',
            answer: '跑',
            hint: '[文言实词]（语文六年级-第7单元）',
            explanation: '文言文中"走"的古义是"跑"，是常见的古今异义实词。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u7l3q7',
            type: 'fill',
            question: '回顾本课知识："之"字最常见的三种用法是"的"、代词和___',
            answer: '去',
            acceptableAnswers: ['去', '去往', '前往'],
            hint: '[文言虚词]（语文六年级-第7单元）',
            explanation: '"之"字三用法：的（修饰）、代词（他/它）、去/往（动词）。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u7l4q7',
            type: 'fill',
            question: '回顾本课知识：《揠苗助长》告诉我们做事不能急于求成、违背___',
            answer: '规律',
            acceptableAnswers: ['规律', '客观规律'],
            hint: '[文言短文]（语文六年级-第7单元）',
            explanation: '《揠苗助长》告诉我们做事不能急于求成、违背客观规律，否则适得其反。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u7l5q7',
            type: 'fill',
            question: '回顾本单元知识：文言文最突出的特点是___凝练',
            answer: '简洁',
            hint: '[文言文入门]（语文六年级-第7单元）',
            explanation: '文言文最突出的特点是简洁凝练，用很少的字表达完整意思。'
          }
        ]
      }
    ...
    lessons: [
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u8l1q7',
            type: 'fill',
            question: '回顾本单元知识：记叙文的核心特点是"以___感人"',
            answer: '事',
            hint: '[文体复习]（语文六年级-第8单元）',
            explanation: '记叙文以事感人，通过叙述事件来表达情感。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u8l2q7',
            type: 'fill',
            question: '回顾本单元知识：写作三步是审题、构思和___',
            answer: '写作',
            hint: '[作文复习]（语文六年级-第8单元）',
            explanation: '写作三步走：审题、构思、写作。先审题再构思最后写作修改。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u8l3q7',
            type: 'fill',
            question: '回顾本单元知识："欲穷千里目，更上一层楼"适合鼓励人___',
            answer: '上进',
            acceptableAnswers: ['上进', '进步', '不断进取'],
            hint: '[古诗文复习]（语文六年级-第8单元）',
            explanation: '"欲穷千里目，更上一层楼"哲理是站得高看得远，适合鼓励人不断上进。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u8l4q7',
            type: 'fill',
            question: '回顾本单元知识：小升初模拟考试第一步是先___',
            answer: '审题',
            hint: '[小升初模拟]（语文六年级-第8单元）',
            explanation: '小升初模拟考试第一步是先审题，看清题目要求再作答。'
          }
        ]
      },
      {
        ...
        practiceQuestions: [
          ...
          },
          {
            id: 'c6u8l5q7',
            type: 'fill',
            question: '回顾六年语文学习：议论文三要素是论点、论据和___',
            answer: '论证',
            hint: '[学期综合测评]（语文六年级-第8单元）',
            explanation: '议论文三要素：论点、论据、论证。六年语文学习圆满结束，毕业快乐！'
          }
        ]
      }
    ]
