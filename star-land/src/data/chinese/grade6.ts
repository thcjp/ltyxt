    ...
    lessons: [
      {
        ...
        learningObjective: '我能理解议论文观点与理由的关系',
        successCriteria: '①能说出观点和理由的关系 ②能区分观点和论据',
        content: [
        ...
        parentTips: '【家长预习】我们平时说话写文章，有时是在"讲故事"——那是记叙文；有…\n共学四步：\n①对话出题：问孩子"议论文的核心目的是什么？"\n②孩子应答：记叙文以事感人，说明文以知启人，议论文以理服人——讲道理、说服别人才是议论文…\n③答错引导：家长可以和孩子玩"辩论游戏"——家长说一个观点让孩子找理由，反过来也行\n④快速检测：议论文的核心目的是什么？、议论文三要素不包括下列哪一项？、议论三角形的顶角代表的是（    ）（填"论点…',
      ...
      },
      {
        ...
        order: 2,
        teachingMethod: '支架式',
        learningObjective: '我能找出议论文的中心论点',
        successCriteria: '①能准确找出中心论点 ②能说出论点出现的位置',
        content: [
        ...
        parentTips: '【家长预习】读一篇议论文，首先要找到作者的论点。论点就是作者对某个问…\n共学四步：\n①对话出题：问孩子"论点最常出现在文章的哪些位置？"\n②孩子应答：论点最常出现在标题（点题）、开头（亮明）或结尾（总结）三个位置。\n③答错引导：家长可以和孩子玩"辩论游戏"——家长说一个观点让孩子找理由，反过来也行\n④快速检测：论点最常出现在文章的哪些位置？、下列哪个词语常用来引出论点？、"总之，我们应该珍惜时间。"这句话中，论点紧跟…',
      ...
      },
      {
        ...
        learningObjective: '我能区分事实论据和道理论据',
        successCriteria: '①能区分事实论据和道理论据 ②能判断论据是否支撑论点',
        content: [
        ...
        parentTips: '【家长预习】论点需要论据来支撑。论据分为两大类：事实论据和道理论据。…\n共学四步：\n①对话出题：问孩子"爱迪生发明电灯试验了上千次"属于哪种论据？"\n②孩子应答：爱迪生试验上千次是真实发生过的具体事例，属于事实论据。\n③答错引导：家长可以和孩子玩"辩论游戏"——家长说一个观点让孩子找理由，反过来也行\n④快速检测："爱迪生发明电灯试验了上千次"属于哪种论据？、下列哪一项是道理论据？、论据分为事实论据和（    ）论据两大类',
      ...
      },
      {
        ...
        learningObjective: '我能用"观点+论据+结论"的结构写简单议论文',
        successCriteria: '①有明确的观点和结论 ②至少使用2个论据支撑观点',
        content: [
        ...
        parentTips: '【家长预习】学会了找论点和论据，接下来我们试着自己写一篇简单的议论文…\n共学四步：\n①对话出题：问孩子"议论模板"我认为什么，因为什么，所以什么"中，"因为"后面填什么？"\n②孩子应答："因为"后面填论据（理由），用来支撑论点。"我认为"后是论点，"所以"后是结论。\n③答错引导：家长可以让孩子先列提纲再写，用"提纲引导法"——先写几个关键词，再扩展成句\n④快速检测：议论模板"我认为（    ），因为（    ）…、写议论文的第一步应该做什么？、议论模板中，"所以"后面填的是（    ）（填…',
    ...
    lessons: [
      {
        ...
        learningObjective: '我能理解小说人物、情节、环境三要素',
        successCriteria: '①能说出小说三要素 ②能从课文中找出对应的要素',
        content: [
        ...
        parentTips: '【家长预习】小说是以刻画人物为中心，通过完整的故事情节和具体的环境描…\n共学四步：\n①对话出题：问孩子"小说三要素是什么？"\n②孩子应答：小说三要素是人物（核心）、情节（骨架）、环境（背景）。\n③答错引导：家长可以带孩子读一段环境描写，用"圈画法"——圈出环境描写的词语，讨论是自然环境还是社会环境\n④快速检测：小说三要素是什么？、小说中最核心的要素是？、小说的"骨架"指的是（    ）（填三要素之一）',
      ...
      },
      {
        ...
        learningObjective: '我能分析小说中圆形人物与扁平人物的特点',
        successCriteria: '①能区分圆形人物和扁平人物 ②能分析人物性格的多面性',
        content: [
        ...
        parentTips: '【家长预习】读小说要分析人物。人物分两种：圆形人物性格丰富、会变化发…\n共学四步：\n①对话出题：问孩子"性格复杂、会成长变化的人物称为？"\n②孩子应答：圆形人物性格丰富、会变化发展，像真实的人；扁平人物性格单一固定。\n③答错引导：家长可以画人物关系图或情节图，用"图表梳理法"——边读边画，帮助理清思路\n④快速检测：性格复杂、会成长变化的人物称为？、分析人物性格可以从下列哪个角度入手？、诸葛亮说"只消三天"，从语言描写可看出他（  …',
      ...
      },
      {
        ...
        order: 3,
        teachingMethod: '对比辨析法',
        learningObjective: '我能区分自然环境与社会环境描写的作用',
        successCriteria: '①能区分自然和社会环境描写 ②能说出环境描写的作用',
        content: [
        ...
        parentTips: '【家长预习】小说中的环境描写分为两类：自然环境描写天气、景色、季节等…\n共学四步：\n①对话出题：问孩子"那天大雾漫天，江上连面对面都看不清"属于哪种环境描写？"\n②孩子应答：大雾是天气现象，属于自然环境描写。\n③答错引导：家长可以带孩子读一段环境描写，用"圈画法"——圈出环境描写的词语，讨论是自然环境还是社会环境\n④快速检测："那天大雾漫天，江上连面对面都看不清"属于哪种…、下列哪一项是社会环境描写？、环境描写分为自然环境和（    ）环境',
      ...
      },
      {
        ...
        learningObjective: '我能梳理小说情节的开端、发展、高潮、结局',
        successCriteria: '①能标出情节的四个阶段 ②能说出高潮部分的内容',
        content: [
        ...
        parentTips: '【家长预习】小说的情节一般分为四个阶段：开端（故事开始，交代背景）、…\n共学四步：\n①对话出题：问孩子"小说情节一般分为几个阶段？"\n②孩子应答：小说情节一般分四个阶段：开端、发展、高潮、结局。\n③答错引导：家长可以画人物关系图或情节图，用"图表梳理法"——边读边画，帮助理清思路\n④快速检测：小说情节一般分为几个阶段？、情节中矛盾最尖锐、最紧张精彩的部分是？、情节曲线中，"山脚"代表的是（    ）阶段',
      ...
      },
      {
        ...
        parentTips: '【家长预习】学完了小说阅读，让我们综合检测一下！这节课我们将阅读小说…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
    ...
    lessons: [
      {
        ...
        order: 1,
        teachingMethod: '情境式',
        learningObjective: '我能理解散文"形散神聚"的特点',
        successCriteria: '①能说出散文形散神聚的特点 ②能找出散文的"神"',
        content: [
        ...
        parentTips: '【家长预习】散文最大的特点是"形散神聚"。"形散"指取材自由，天南海…\n共学四步：\n①对话出题：问孩子"散文最大的特点是什么？"\n②孩子应答：散文最大的特点是"形散神聚"：形散指取材自由，神聚指中心统一。\n③答错引导：家长可以带孩子找文中的情感词，用"情感词定位法"——圈出情感词，串联起来感受\n④快速检测：散文最大的特点是什么？、"形散"中的"形"指的是什么？、散文"形散神聚"中，"神"指的是（    ）',
      ...
      },
      {
        ...
        learningObjective: '我能品味散文优美含蓄的语言',
        successCriteria: '①能找出优美的语句并赏析 ②能说出语言的含蓄之处',
        content: [
        ...
        parentTips: '【家长预习】散文的语言优美而含蓄。优美在于用词生动、修辞丰富、节奏感…\n共学四步：\n①对话出题：问孩子"散文语言的两个突出特点是？"\n②孩子应答：散文语言优美（用词生动、修辞丰富）又含蓄（言外有意、回味悠长）。\n③答错引导：家长可以带孩子找文中的情感词，用"情感词定位法"——圈出情感词，串联起来感受\n④快速检测：散文语言的两个突出特点是？、"小草偷偷地从土里钻出来"中"偷偷地""钻"用…、品味散文语言"三看"：看用词、看修辞、看（  …',
      ...
      },
      {
        ...
        order: 3,
        teachingMethod: '支架式',
        learningObjective: '我能找到散文的情感线索',
        successCriteria: '①能找出情感线索 ②能说出作者的情感变化',
        content: [
        ...
        parentTips: '【家长预习】散文以抒情为主，情感是散文的灵魂。很多散文有一条情感线索…\n共学四步：\n①对话出题：问孩子"散文的灵魂是什么？"\n②孩子应答：散文以抒情为主，情感是散文的灵魂，贯穿全文。\n③答错引导：家长可以带孩子找文中的情感词，用"情感词定位法"——圈出情感词，串联起来感受\n④快速检测：散文的灵魂是什么？、找情感线索的第一步是？、《背影》的情感线索是：感伤→感动→（    ）',
      ...
      },
      {
        ...
        learningObjective: '我能模仿范文的语言和结构进行仿写',
        successCriteria: '①仿写结构句式与原文一致 ②语言通顺，内容合理',
        content: [
        ...
        parentTips: '【家长预习】品读了散文的语言和情感，现在我们试着仿写散文。仿写不是照…\n共学四步：\n①对话出题：问孩子"散文仿写的目的是什么？"\n②孩子应答：仿写的目的是学习名家的表达方式和语言风格，从模仿到创造，写出自己的文字。\n③答错引导：家长可以让孩子先列提纲再写，用"提纲引导法"——先写几个关键词，再扩展成句\n④快速检测：散文仿写的目的是什么？、仿写三步走的正确顺序是？、"小草偷偷地钻出来"仿写为"小花（    ）地…',
      ...
      },
      {
        ...
        parentTips: '【家长预习】学完了散文鉴赏，让我们综合检测一下！这节课我们将阅读散文…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
    ...
    lessons: [
      {
        ...
        learningObjective: '我能用外貌细节描写刻画人物形象',
        successCriteria: '①能写出至少3处外貌细节 ②外貌描写生动，突出人物特点',
        content: [
        ...
        parentTips: '【家长预习】细节描写是记叙文的灵魂。外貌细节描写用"放大镜法"——聚…\n共学四步：\n①对话出题：问孩子"外貌细节描写的"放大镜法"核心是什么？"\n②孩子应答：放大镜法的核心是聚焦人物一个最有特点的特征，细致地描写，让人物形象鲜活。\n③答错引导：家长可以做动作或做表情让孩子描写，用"体验观察法"——先观察再写，写完对照\n④快速检测：外貌细节描写的"放大镜法"核心是什么？、下列哪句是好的外貌细节描写？、放大镜法三步：选特征、细观察、用（    ）',
      ...
      },
      {
        ...
        learningObjective: '我能用动作细节描写展现人物性格',
        successCriteria: '①能写出至少3处动作细节 ②动作描写准确，展现性格',
        content: [
        ...
        parentTips: '【家长预习】动作细节描写用"慢镜头法"——把一个快速的动作分解成几个…\n共学四步：\n①对话出题：问孩子"动作细节描写的"慢镜头法"核心是什么？"\n②孩子应答：慢镜头法的核心是把一个快速动作分解成几个连续的小动作，像慢镜头一样写清楚。\n③答错引导：家长可以做动作或做表情让孩子描写，用"体验观察法"——先观察再写，写完对照\n④快速检测：动作细节描写的"慢镜头法"核心是什么？、下列哪句用了慢镜头法？、慢镜头法的关键是用好（    ）（填一种词性）',
      ...
      },
      {
        ...
        learningObjective: '我能用心理细节描写表现人物内心',
        successCriteria: '①能写出至少3处心理细节 ②心理描写真实，表现内心',
        content: [
        ...
        parentTips: '【家长预习】心理细节描写用"内心独白法"——把人物心里想的话写出来，…\n共学四步：\n①对话出题：问孩子"心理细节描写的"内心独白法"核心是什么？"\n②孩子应答：内心独白法的核心是写出人物心里想的话，让读者看到人物的内心世界。\n③答错引导：家长可以做动作或做表情让孩子描写，用"体验观察法"——先观察再写，写完对照\n④快速检测：心理细节描写的"内心独白法"核心是什么？、下列哪句用了内心独白法？、心理描写四种方法：内心独白、动作暗示、神态表现…',
      ...
      },
      {
        ...
        learningObjective: '我能用环境细节描写烘托气氛',
        successCriteria: '①能写出至少3处环境细节 ②环境描写烘托气氛',
        content: [
        ...
        parentTips: '【家长预习】环境细节描写用"五感法"——调动视觉、听觉、嗅觉、味觉、…\n共学四步：\n①对话出题：问孩子"环境细节描写的"五感法"包括哪五种感官？"\n②孩子应答：五感法包括视觉（看）、听觉（听）、嗅觉（闻）、味觉（尝）、触觉（触）五种感官。\n③答错引导：家长可以做动作或做表情让孩子描写，用"体验观察法"——先观察再写，写完对照\n④快速检测：环境细节描写的"五感法"包括哪五种感官？、"鸟儿叽叽喳喳地唱歌"调动了哪种感官？、五感法中，"微风拂过脸颊凉丝丝的"调动的是（ …',
      ...
      },
      {
        ...
        parentTips: '【家长预习】学完了四种细节描写，现在我们综合运用，写一篇500字的记…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
    ...
    lessons: [
      {
        ...
        order: 1,
        teachingMethod: '情境式',
        learningObjective: '我能背诵古诗《古诗哲理》并理解诗句的意思和表达的情感',
        successCriteria: '①能正确流利背诵《古诗哲理》全诗 ②能说出诗句的意思和诗人表达的情感',
        content: [
        ...
        parentTips: '【家长预习】有些古诗不仅画面美，还蕴含深刻的人生哲理。读这样的诗，既…\n共学四步：\n①对话出题：问孩子"不识庐山真面目，只缘身在此山中"蕴含的哲理是？"\n②孩子应答：身在山中反而看不清庐山全貌，哲理是：当局者迷，旁观者清，要全面认识事物需跳出…\n③答错引导：家长可以和孩子一起看课文插图，用"画面记忆法"——把每句诗变成一幅画，看图背诗\n④快速检测："不识庐山真面目，只缘身在此山中"蕴含的哲理是？、"欲穷千里目，更上一层楼"蕴含的哲理是？、"不识庐山真面目，只缘身在此山中"作者是宋代的…',
      ...
      },
      {
        ...
        learningObjective: '我能背诵古诗《古诗意境》并理解诗句的意思和表达的情感',
        successCriteria: '①能正确流利背诵《古诗意境》全诗 ②能说出诗句的意思和诗人表达的情感',
        content: [
        ...
        youDo: '孩子独立画画面并体会意境。',
        parentTips: '【家长预习】古诗的意境由画面和情感融合而成。画面是诗中描绘的景象，情…\n共学四步：\n①对话出题：问孩子"古诗的意境由什么融合而成？"\n②孩子应答：意境由画面（诗中景象）和情感（诗人感情）融合而成，画面+情感=意境。\n③答错引导：家长可以和孩子一起看课文插图，用"画面记忆法"——把每句诗变成一幅画，看图背诗\n④快速检测：古诗的意境由什么融合而成？、《静夜思》中"床前明月光"主要描绘了什么？、《静夜思》表达的情感是（    ）之情',
      ...
      },
      {
        ...
        youDo: '孩子独立翻译短篇文言文。',
        parentTips: '【家长预习】文言文是古人的书面语言，简洁凝练。读短篇文言文要做到：读…\n共学四步：\n①对话出题：问孩子"兔走触株"中"走"的意思是？"\n②孩子应答："走"在古文中是"跑"的意思，古今异义。"兔走触株"是兔子跑过来撞到树桩。\n③答错引导：家长可以和孩子一起逐字对照注释，用"字字对译法"——一个字一个字地看注释，连起来理解句意\n④快速检测："兔走触株"中"走"的意思是？、"因释其耒而守株"中"释"的意思是？、"冀复得兔"中"冀"的意思是（    ）',
      ...
      },
      {
        ...
        parentTips: '【家长预习】学古诗文学了就要会默写、会运用。默写要准确不写错别字，运…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
      ...
      },
      {
        ...
        parentTips: '【家长预习】学完了古诗文综合，让我们检测一下！这节课将练习默写、理解…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
    ...
    lessons: [
      {
        ...
        learningObjective: '我能写一篇回忆小学生活的成长故事',
        successCriteria: '①能选取至少2件印象深刻的事 ②叙事清楚，感情真挚',
        content: [
        ...
        parentTips: '【家长预习】小学六年，我们经历了许多难忘的事。回忆小学生活，把成长故…\n共学四步：\n①对话出题：问孩子"成长故事不需要写下列哪个要素？"\n②孩子应答：成长故事要素：时间、地点、人物、事件、感受。论点论据是议论文的要素，不需要。\n③答错引导：家长可以和孩子一起翻看老照片，用"照片回忆法"——边看照片边聊往事，再动笔写\n④快速检测：成长故事不需要写下列哪个要素？、成长纪念册的组成不包括下列哪项？、成长故事要写清楚时间、地点、人物、事件和（  …',
      ...
      },
      {
        ...
        parentTips: '【家长预习】给未来的自己写一封信，记录现在的自己，表达对未来的期望和…\n共学四步：\n①对话出题：问孩子"书信格式的正确顺序是？"\n②孩子应答：书信格式顺序：称呼→问候→正文→祝福→署名→日期。\n③答错引导：家长可以找出以前的信件给孩子看格式，用"格式示范法"——对照真实信件学格式\n④快速检测：书信格式的正确顺序是？、书信中"称呼"应该怎么写？、写给未来的信内容包括现在的我、我的期望和我的（…',
      ...
      },
      {
        ...
        order: 3,
        teachingMethod: '情境式',
        learningObjective: '我能写一篇毕业演讲稿，表达感谢与告别之情',
        successCriteria: '①演讲稿格式正确，有称呼和结尾 ②内容表达感谢与告别，感情真挚',
        content: [
        ...
        parentTips: '【家长预习】毕业之际，用一篇演讲稿告别母校、感谢师长。毕业演讲包含三…\n共学四步：\n①对话出题：问孩子"毕业演讲的三部分是？"\n②孩子应答：毕业演讲三部分：回忆（小学美好回忆）、感谢（感谢老师同学）、展望（对未来的期…\n③答错引导：家长可以让孩子先对着镜子练说，用"先说后写法"——先口头演讲再写稿子\n④快速检测：毕业演讲的三部分是？、毕业演讲稿的开头应该有？、毕业演讲中"感谢"部分主要感谢（    ）和同学',
      ...
      },
      {
        ...
        order: 4,
        teachingMethod: '项目式',
        learningObjective: '我能参与制作毕业纪念册',
        successCriteria: '①能参与制作纪念册 ②能完成自己负责的部分',
        content: [
        ...
        weDo: '亲子一起制作纪念册，分工合作。',
        youDo: '孩子独立完成个人负责的部分。',
        parentTips: '【家长预习】制作毕业纪念册需要小组合作。合理分工：封面设计、文章撰写…\n共学四步：\n①对话出题：问孩子"制作毕业纪念册的小组分工不包括下列哪项？"\n②孩子应答：小组分工包括封面设计、文章撰写、照片整理、装饰美化。数学竞赛与制作纪念册无关。\n③答错引导：家长可以和孩子一起排练，用"模拟练习法"——在家先演练一遍\n④快速检测：制作毕业纪念册的小组分工不包括下列哪项？、小组合作的三原则是？、毕业纪念册的封面设计包括标题和毕业（    ）',
      ...
      },
      {
        ...
        order: 5,
        teachingMethod: '综合展示',
        learningObjective: '我能展示学习成果并与同学分享交流',
        successCriteria: '①能清楚展示自己的成果 ②能说出自己的收获',
        content: [
        ...
        parentTips: '【家长预习】毕业分享会上，展示成长纪念册，发表毕业演讲，和同学老师分…\n共学四步：\n①对话出题：问孩子"毕业分享会上不需要做下列哪件事？"\n②孩子应答：毕业分享会包括展示纪念册、发表演讲、互赠留言等。参加考试与分享会无关。\n③答错引导：家长可以和孩子一起排练，用"模拟练习法"——在家先演练一遍\n④快速检测：毕业分享会上不需要做下列哪件事？、展示成果时应该？、毕业分享会展示的内容包括成长纪念册和毕业（  …',
    ...
    lessons: [
      {
        ...
        parentTips: '【家长预习】文言文是古人的书面语言，与现代文有很多不同。文言文特点：…\n共学四步：\n①对话出题：问孩子"文言文最突出的特点是？"\n②孩子应答：文言文最突出的特点是简洁凝练，用很少的字表达完整的意思。\n③答错引导：家长可以和孩子一起逐字对照注释，用"字字对译法"——一个字一个字地看注释，连起来理解句意\n④快速检测：文言文最突出的特点是？、文言文中"走"的意思是？、文言文"学"对应的现代文意思是（    ）',
      ...
      },
      {
        ...
        parentTips: '【家长预习】文言实词是有实在意义的词，如名词、动词、形容词。掌握常见…\n共学四步：\n①对话出题：问孩子"去"在文言文中的古义是？"\n②孩子应答："去"在文言文中古义是"离开"，今义是"前往"，是古今异义词。\n③答错引导：家长可以和孩子一起逐字对照注释，用"字字对译法"——一个字一个字地看注释，连起来理解句意\n④快速检测："去"在文言文中的古义是？、"妻"在古文中的意思是？、"兔走触株"中"走"的古义是（    ）',
      ...
      },
      {
        ...
        weDo: '亲子一起辨析虚词，互相考问。',
        youDo: '孩子独立判断虚词用法。',
        parentTips: '【家长预习】文言虚词没有实在意义，但在句中起语法作用。常见虚词有"之…\n共学四步：\n①对话出题：问孩子"古之学者"中"之"的用法是？"\n②孩子应答："古之学者"中"之"是"的"的意思，表修饰关系，"古之学者"即"古代的学者"。\n③答错引导：家长可以和孩子一起逐字对照注释，用"字字对译法"——一个字一个字地看注释，连起来理解句意\n④快速检测："古之学者"中"之"的用法是？、"学而时习之"中"之"的用法是？、"吾欲之南海"中"之"的意思是（    ）',
      ...
      },
      {
        ...
        parentTips: '【家长预习】学了实词虚词，我们来读一篇完整的文言短文《揠苗助长》。读…\n共学四步：\n①对话出题：问孩子"揠苗助长"中"揠"的意思是？"\n②孩子应答："揠"是"拔"的意思。"揠苗"就是把禾苗拔高。\n③答错引导：家长可以和孩子一起逐字对照注释，用"字字对译法"——一个字一个字地看注释，连起来理解句意\n④快速检测："揠苗助长"中"揠"的意思是？、"宋人有闵其苗之不长"中"闵"的意思是？、"苗则槁矣"中"槁"的意思是（    ）',
      ...
      },
      {
        ...
        parentTips: '【家长预习】学完了文言文入门，让我们综合检测一下！这节课将练习文言文…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
    ...
    lessons: [
      {
        ...
        parentTips: '【家长预习】小学六年我们学过很多文体：记叙文、说明文、议论文、小说、…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
      ...
      },
      {
        ...
        parentTips: '【家长预习】写作也要分文体。记叙文写事要六要素齐全、细节生动；议论文…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
      ...
      },
      {
        ...
        parentTips: '【家长预习】古诗文是语文学习的重点。今天我们总复习古诗哲理、意境、默…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
      ...
      },
      {
        ...
        weDo: '亲子一起做模拟题，互相讨论。',
        youDo: '孩子独立完成小升初模拟测试。',
        parentTips: '【家长预习】小升初模拟测试来了！这是一套综合阅读与写作的模拟题，涵盖…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
      ...
      },
      {
        ...
        parentTips: '【家长预习】六年语文学习到此圆满结束！最后一节课是学期综合测评和毕业…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
