    ...
    lessons: [
      {
        ...
        content: [
          ...
          { type: 'tip', content: '本课主要使用支架式：议论三角形：通过科学方法提升学习效果', label: '教学方法', animationType: 'pulse' },
        ],
        iDo: '家长画一个"观点+理由+结论"的议论三角形，示范如何用三角形组织一篇小议论文，让孩子看到议论的结构。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起就"小学生要不要做家务"这个话题，合作画议论三角形，讨论观点和论据。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立就"课间该不该玩手机"画一个议论三角形，写出论点、论据和结论。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '讲道理说服别人',
            hint: '想想议论文和其他文体的区别',
            explanation: '记叙文以事感人，说明文以知启人，议论文以理服人——讲道理、说服别人才是议论文的核心目的。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l1q2',
            type: 'choice',
            ...
            answer: '情节',
            hint: '情节是哪种文体的要素',
            explanation: '议论文三要素是论点、论据、论证。情节是小说和记叙文的要素，不属于议论文。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l1q3',
            type: 'fill',
            ...
            answer: '论点',
            hint: '顶端统领全局的是什么',
            explanation: '议论三角形顶角是论点（观点），它在顶端统领全篇；左下角是论据，右下角是结论。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l1q4',
            type: 'choice',
            ...
            answer: '结论',
            hint: '看看"所以"后面是什么',
            explanation: '"所以"引导的是由论据推导出的结论。"读书能开阔眼界"是论据，"我们应该多读书"是由此得出的结论。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l1q5',
            type: 'choice',
            ...
            hint: '议论文是讲道理的',
            explanation: '"下雨天应该带伞，因为淋雨会感冒"提出了观点并给出理由，是议论文表达。第一句是记叙，第三句是描写。这是期末常考题！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l1q6',
            type: 'drag',
            ...
            hint: '顶角统领，两底角支撑',
            explanation: '议论三角形：顶角是论点（统领），左下角是论据（支撑），右下角是结论（总结）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l1q7',
            type: 'fill',
            ...
            explanation: '记叙文六要素：时间、地点、人物、起因、经过、结果。议论文要学好，先复习记叙文的要素。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范找论点：拿一篇短文，分别在标题、开头、结尾处标注论点，让孩子看到论点的常见位置。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起读一篇议论文，一起找论点，互相检查找得对不对。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立阅读一篇议论文，找出论点并标注其位置。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '标题、开头或结尾',
            hint: '回忆论点的三个常见位置',
            explanation: '论点最常出现在标题（点题）、开头（亮明）或结尾（总结）三个位置。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l2q2',
            type: 'choice',
            ...
            answer: '我认为',
            hint: '哪个词表示提出主张',
            explanation: '"我认为"常用来亮明论点（主张）。"因为"引出论据，"例如"引出举例。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l2q3',
            type: 'fill',
            ...
            answer: '总之',
            hint: '哪个词引出了总结性主张',
            explanation: '"总之"是引出结论性论点的标志性词语，论点"我们应该珍惜时间"紧跟其后。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l2q4',
            type: 'choice',
            ...
            answer: '论据',
            hint: '看看是主张还是理由',
            explanation: '"因为"引出的是理由，"读书能增长知识"是用来支撑论点的论据，不是论点本身。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l2q5',
            type: 'choice',
            ...
            explanation: '"可见"引出结论性论点"我们应该坚持运动"。"运动有益健康"是开头引入，"跑步能增强心肺功能"是论据。这是期末常考题！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l2q6',
            type: 'drag',
            ...
            hint: '主张是论点，理由和例子是论据',
            explanation: '"我认为诚实最重要"是论点（主张），其余两句分别用"因为""例如"引出，都是论据。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l2q7',
            type: 'fill',
            ...
            explanation: '“像”是比喻的标志，把月亮比作小船，是比喻修辞。议论文也常用修辞增强说服力。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长对比事实论据和道理论据，举出两类论据的例子，让孩子看清两者的区别。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起辨析：给出几个论据，一起判断是事实论据还是道理论据。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立找论据：为一个论点分别找出一个事实论据和一个道理论据。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '事实论据',
            hint: '这是发生过的事还是公认的理',
            explanation: '爱迪生试验上千次是真实发生过的具体事例，属于事实论据。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l3q2',
            type: 'choice',
            ...
            answer: '孔子说"学而时习之"',
            hint: '名言警句属于哪类论据',
            explanation: '孔子的话是名言警句，属于道理论据。调查数据和史实都属于事实论据。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l3q3',
            type: 'fill',
            ...
            answer: '道理',
            hint: '用名言原理说理的是哪类',
            explanation: '论据分为事实论据（事例、数据）和道理论据（名言、原理）两大类。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l3q4',
            type: 'choice',
            ...
            answer: '蚂蚁齐心协力搬走大食物',
            hint: '论据要紧扣论点且有说服力',
            explanation: '"蚂蚁齐心协力搬走大食物"用具体事例证明团结的力量，紧扣论点且典型，是合适的事实论据。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l3q5',
            type: 'choice',
            ...
            answer: '事实论据（数据）',
            hint: '统计数据属于哪类论据',
            explanation: '统计数据是客观事实，属于事实论据。这是期末常考的论据辨析题！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l3q6',
            type: 'drag',
            ...
            explanation: '牛顿发现万有引力和高考录取率是事实（事例/数据），谚语和孟子的话是道理（名言警句）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l3q7',
            type: 'fill',
            ...
            explanation: '记叙顺序有顺叙、倒叙、插叙。先写结果后写起因的是倒叙。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        content: [
          ...
          { type: 'tip', content: '本课主要使用支架式：议论模板：通过科学方法提升学习效果', label: '教学方法', animationType: 'pulse' },
        ],
        iDo: '家长示范写议论文：用模板"我认为……因为……所以……"写一篇小议论文，让孩子看清写作过程。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起填模板：选一个话题，一起填入论点、论据和结论。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立写一篇简单议论文，包含论点、论据和结论。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '论据',
            hint: '"因为"引出的是理由还是主张',
            explanation: '"因为"后面填论据（理由），用来支撑论点。"我认为"后是论点，"所以"后是结论。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l4q2',
            type: 'choice',
            ...
            answer: '亮明论点',
            hint: '先有主张才能找理由支撑',
            explanation: '写议论文四步走：①亮明论点 ②摆出论据 ③分析论证 ④得出结论。第一步是亮明论点。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l4q3',
            type: 'fill',
            ...
            answer: '结论',
            hint: '"所以"是推导出的结果',
            explanation: '"所以"后面填结论，是由论据推导出的总结性主张。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l4q4',
            type: 'choice',
            ...
            answer: '读书能增长知识、开阔眼界',
            hint: '论据要紧扣论点并支持论点',
            explanation: '论据必须紧扣论点并支持论点。"读书能增长知识、开阔眼界"正面支撑"读书有益"，是合适的论据。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l4q5',
            type: 'choice',
            ...
            answer: '论据要紧扣并支撑论点',
            hint: '论据的作用是什么',
            explanation: '论据的作用是支撑论点，必须紧扣论点、与论点密切相关，不能跑题。这是期末常考的写作要点！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l4q6',
            type: 'drag',
            ...
            explanation: '写议论文四步走：①亮明论点 ②摆出论据 ③分析论证 ④得出结论，逻辑顺序不能乱。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l4q7',
            type: 'fill',
            ...
            answer: '所以',
            hint: '[关联词]（五年级语文-第1单元）',
            explanation: '“因为……所以……”表因果关系，填“所以”。议论文中也常用关联词把论点和论据连起来。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范检测：做一道议论文读写题，示范如何找论点论据、如何写议论片段。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起练习：读一段议论文，一起找论点和论据。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立完成议论文读写测试，读议论文找论点论据，写一段简单议论文。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '论点、论据、论证',
            hint: '回忆议论文三要素',
            explanation: '议论文三要素是论点（主张）、论据（理由证据）、论证（用论据证明论点的过程）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l5q2',
            type: 'choice',
            ...
            answer: '道理论据',
            hint: '俗语名言属于哪类论据',
            explanation: '俗语"失败是成功之母"是公认的哲理名言，属于道理论据。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l5q3',
            type: 'fill',
            ...
            answer: '总之',
            hint: '哪个词引出总结性论点',
            explanation: '"总之"是引出结论性论点的标志词，论点"我们应该养成阅读习惯"紧跟其后。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l5q4',
            type: 'choice',
            ...
            explanation: '"总之"引出结论性论点。这句中"我们每个人都应该拥有它"是作者号召大家的主张，完整论点是"每个人都应该拥有诚实这种美德"。"诚实是一种美德"是铺垫，"总之"只是过渡词。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l5q5',
            type: 'choice',
            ...
            explanation: '爱迪生的事例（事实论据）加名言（道理论据），一事实一道理，紧扣"勤奋出天才"论点，最有说服力。这是期末常考题！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l5q6',
            type: 'drag',
            ...
            explanation: '"我认为诚信最重要"是论点，"因为曾子杀猪教子"是论据，"所以我们要诚实守信"是结论，构成完整的议论结构。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u1l5q7',
            type: 'fill',
            ...
            explanation: '记叙文顺序有顺叙（按时间先后）、倒叙（先写结果再写起因）、插叙（中间插入），是五年级记叙文进阶学过的。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      }
    ]
    ...
    lessons: [
      {
        ...
        content: [
          ...
          { type: 'tip', content: '本课主要使用支架式：要素图：通过科学方法提升学习效果', label: '教学方法', animationType: 'pulse' },
        ],
        iDo: '家长画小说三要素图，以一个熟悉的故事为例，示范如何辨认三要素。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起分析一个童话故事的三要素，互相补充。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立辨认一篇短篇小说的人物、情节、环境。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '人物、情节、环境',
            hint: '回忆小说的核心要素',
            explanation: '小说三要素是人物（核心）、情节（骨架）、环境（背景）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l1q2',
            type: 'choice',
            ...
            answer: '人物',
            hint: '小说以什么为中心刻画',
            explanation: '小说以刻画人物为中心，人物是小说最核心的要素，情节和环境都是为表现人物服务的。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l1q3',
            type: 'fill',
            ...
            answer: '情节',
            hint: '哪个要素像骨架一样支撑故事',
            explanation: '情节是小说的骨架，包括开端、发展、高潮、结局，支撑起整个故事。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l1q4',
            type: 'choice',
            ...
            answer: '环境',
            hint: '大雾是天气描写，属于什么',
            explanation: '"大雾漫天"是自然环境描写，属于小说三要素中的环境要素。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l1q5',
            type: 'choice',
            ...
            answer: '论点',
            hint: '论点是哪种文体的要素',
            explanation: '论点是议论文的要素，不属于小说三要素（人物、情节、环境）。这是期末常考题！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l1q6',
            type: 'drag',
            ...
            hint: '谁是人，什么是事，什么是背景',
            explanation: '诸葛亮是人物，草船借箭是情节（事件），长江大雾是环境（背景）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l1q7',
            type: 'fill',
            ...
            explanation: '《西游记》是五年级名著阅读篇目，孙悟空的兵器是金箍棒(定海神针)。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范分析人物性格变化：以一个人物为例，从行为、语言、心理分析其性格。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起分析一个人物，填写人物分析卡。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立分析一篇小说中的人物性格，完成人物分析卡。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '圆形人物',
            hint: '哪种人物像真实的人一样丰富',
            explanation: '圆形人物性格丰富、会变化发展，像真实的人；扁平人物性格单一固定。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l2q2',
            type: 'choice',
            ...
            answer: '外貌、语言、动作、心理',
            hint: '回忆人物分析四角度',
            explanation: '分析人物四角度：外貌、语言、动作、心理，综合这四点判断人物性格。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l2q3',
            type: 'fill',
            ...
            hint: '敢说"只消三天"说明很有把握',
            explanation: '"只消三天"的语言描写表现诸葛亮胸有成竹、从容自信的性格。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l2q4',
            type: 'choice',
            ...
            answer: '动作描写',
            hint: '摔杯子是动作还是语言',
            explanation: '"摔杯子"是具体的动作行为，属于动作描写，表现人物愤怒的情绪。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l2q5',
            type: 'choice',
            ...
            answer: '性格丰富会发展变化',
            hint: '圆形人物像真实的人',
            explanation: '圆形人物性格丰富、会成长变化，形象立体丰满。这是期末常考的人物类型辨析题！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l2q6',
            type: 'drag',
            ...
            hint: '看长相、说话、想法、行为',
            explanation: '"羽扇纶巾"是外貌，"大喊"是语言，"心想"是心理，"拔腿就跑"是动作。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l2q7',
            type: 'fill',
            ...
            explanation: '描写表情神色属于神态描写，是五年级学过的人物描写方法之一。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长对比自然和社会环境，示范如何辨认两种环境描写及其作用。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起辨析：给出几段环境描写，一起判断是自然环境还是社会环境。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立找环境描写，并说明其作用。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '自然环境',
            hint: '大雾是天气还是时代',
            explanation: '大雾是天气现象，属于自然环境描写。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l3q2',
            type: 'choice',
            ...
            answer: '故事发生在抗战时期',
            hint: '哪个写的是时代背景',
            explanation: '"故事发生在抗战时期"描写时代背景，属于社会环境。其余两项是自然环境（天气景色）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l3q3',
            type: 'fill',
            ...
            answer: '社会',
            hint: '描写时代背景的是哪种环境',
            explanation: '环境描写分为自然环境（天气景色）和社会环境（时代背景）两类。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l3q4',
            type: 'choice',
            ...
            answer: '烘托紧张气氛',
            hint: '阴云雷声给人什么感觉',
            explanation: '"阴云密布，雷声滚滚"渲染压抑紧张的氛围，主要作用是烘托紧张气氛。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l3q5',
            type: 'choice',
            ...
            answer: '社会环境',
            hint: '断壁残垣和人们的状态反映什么',
            explanation: '断壁残垣和人们面黄肌瘦反映了社会状况（战乱后的破败），属于社会环境描写。这是期末常考题！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l3q6',
            type: 'drag',
            ...
            explanation: '大雪纷飞、夕阳西下是自然环境（天气景色）；解放前生活困苦、闹饥荒是社会环境（时代社会状况）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l3q7',
            type: 'fill',
            ...
            answer: '诸葛亮',
            hint: '[名著阅读]（五年级语文-第4单元）',
            explanation: '《三国演义》是五年级名著阅读篇目，“草船借箭”的主人公是诸葛亮。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范画情节曲线：以一个故事为例，标出开端、发展、高潮、结局四点。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起画情节曲线：共同分析一个故事的情节发展。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立画情节曲线，标注四个阶段。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '四个',
            hint: '回忆开端发展高潮结局',
            explanation: '小说情节一般分四个阶段：开端、发展、高潮、结局。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l4q2',
            type: 'choice',
            ...
            answer: '高潮',
            hint: '哪个阶段像山顶一样最高',
            explanation: '高潮是矛盾最激烈、最紧张精彩的部分，是情节曲线的最高点。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l4q3',
            type: 'fill',
            ...
            answer: '开端',
            hint: '故事平稳起步的地方',
            explanation: '开端是情节的起点，像山脚一样平稳起步，交代背景引出矛盾。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l4q4',
            type: 'choice',
            ...
            answer: '高潮',
            hint: '这部分是不是最紧张精彩',
            explanation: '"草船借箭、万箭齐发"是矛盾最激烈、最精彩的部分，属于高潮阶段。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l4q5',
            type: 'choice',
            ...
            explanation: '发展阶段的作用是展开矛盾、推进故事，把情节从开端推向高潮。交代背景是开端，解决矛盾是结局。这是期末常考题！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l4q6',
            type: 'drag',
            ...
            explanation: '情节四阶段顺序：开端（起步）→发展（上坡）→高潮（登顶）→结局（下山）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l4q7',
            type: 'fill',
            ...
            answer: '武松',
            hint: '[名著阅读]（五年级语文-第4单元）',
            explanation: '《水浒传》是五年级名著阅读篇目，“武松打虎”的主人公是武松。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范检测：做一道小说阅读题，示范如何分析人物、环境、情节。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起练习：读一段小说，一起分析三要素。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立完成小说阅读测试，分析人物性格、环境作用、情节发展。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          ...
          },
          {
            ...
            answer: '论据',
            hint: '哪个不属于人物描写角度',
            explanation: '分析人物四角度：外貌、语言、动作、心理。论据是议论文的要素，不是人物分析角度。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l5q3',
            type: 'fill',
            ...
            answer: '环境',
            hint: '描写时代背景的是哪种环境',
            explanation: '环境描写分为自然环境和社会环境两类。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l5q4',
            type: 'choice',
            ...
            answer: '高潮',
            hint: '哪个阶段像山顶',
            explanation: '高潮是矛盾最尖锐、最紧张精彩的阶段，是情节曲线的最高点。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l5q5',
            type: 'choice',
            ...
            answer: '动作描写',
            hint: '咬牙、握拳、不退是什么描写',
            explanation: '咬紧牙关、握紧拳头、不后退都是具体动作，属于动作描写，表现人物坚毅。这是期末常考题！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l5q6',
            type: 'drag',
            ...
            answer: '开端,发展,高潮,结局',
            hint: '像爬山：起步、上坡、登顶、下山',
            explanation: '情节四阶段顺序：开端→发展→高潮→结局。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u2l5q7',
            type: 'fill',
            ...
            answer: '水浒传',
            hint: '[名著阅读]（五年级语文-第4单元）',
            explanation: '武松打虎出自施耐庵《水浒传》，是五年级名著阅读学过的经典故事。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      }
    ]
    ...
    lessons: [
      {
        ...
        iDo: '家长读散文找"形"和"神"：示范如何找出散落的材料和统一的中心。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起找散文的形和神，互相讨论。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立找一篇散文的"形"（材料）和"神"（中心）。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '形散神聚',
            hint: '散文的标志性特点',
            explanation: '散文最大的特点是"形散神聚"：形散指取材自由，神聚指中心统一。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l1q2',
            type: 'choice',
            ...
            answer: '取材和材料',
            hint: '形散是表面上的散',
            explanation: '"形"指取材和材料，"形散"指散文取材自由，材料可以散落各处。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l1q3',
            type: 'fill',
            ...
            hint: '神聚是内核的统一',
            explanation: '"神"指中心主题，"神聚"指所有材料都围绕统一的中心。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l1q4',
            type: 'choice',
            ...
            answer: '形散',
            hint: '材料多而散体现什么',
            explanation: '《春》写了多种景物，取材自由散落，体现了散文"形散"的特点。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l1q5',
            type: 'choice',
            ...
            answer: '材料自由但都围绕一个中心',
            hint: '形散神聚的真正含义',
            explanation: '形散神聚指取材自由（形散）但中心统一（神聚），材料看似散落实则都围绕一个中心。这是期末常考题！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l1q6',
            type: 'drag',
            ...
            explanation: '写多种景物、取材广是形散（材料）；赞美春天、中心统一是神聚（主题）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l1q7',
            type: 'fill',
            ...
            answer: '拟人',
            hint: '[修辞手法]（五年级语文-第1单元）',
            explanation: '把鸟儿当人来写，赋予人的动作“唱歌”，是拟人修辞。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范朗读品味散文语言，读出节奏和情感，让孩子感受语言之美。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起朗读散文，互相品味优美语句。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立朗读散文并品味语言，摘抄优美语句。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '优美与含蓄',
            hint: '回忆散文语言特点',
            explanation: '散文语言优美（用词生动、修辞丰富）又含蓄（言外有意、回味悠长）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l2q2',
            type: 'choice',
            ...
            answer: '拟人',
            hint: '把小草当成人来写',
            explanation: '"偷偷地""钻"把小草当成人来写，赋予小草人的动作，是拟人修辞。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l2q3',
            type: 'fill',
            ...
            hint: '长短句叠词的美感',
            explanation: '品味散文语言三看：看用词（精准生动）、看修辞（比喻拟人等）、看节奏（长短句、叠词的音韵美）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l2q4',
            type: 'choice',
            ...
            answer: '含蓄有言外之意',
            hint: '表面写路，实则表达什么',
            explanation: '这句话表面写路，实则含蓄表达"希望要靠行动去创造"，言外有意，回味悠长。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l2q5',
            type: 'choice',
            ...
            answer: '增强音韵美和节奏感',
            hint: '叠词读起来有什么感觉',
            explanation: '叠词"嫩嫩的""绿绿的"读起来朗朗上口，增强了散文的音韵美和节奏感。这是期末常考的语言赏析题！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l2q6',
            type: 'drag',
            ...
            explanation: '"偷偷地钻""嫩嫩绿绿"用词生动形象是优美；"成了路""希望无所谓有"言外有意是含蓄。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l2q7',
            type: 'fill',
            ...
            answer: '夸张',
            hint: '[修辞手法]（五年级语文-第1单元）',
            explanation: '“三千尺”故意夸大，是夸张修辞，突出瀑布之高。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范找情感线索：以一篇散文为例，标出情感词和情感变化。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起找情感线索，讨论情感如何变化。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立找一篇散文的情感线索，画出情感变化曲线。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '情感',
            hint: '散文以什么为主',
            explanation: '散文以抒情为主，情感是散文的灵魂，贯穿全文。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l3q2',
            type: 'choice',
            ...
            answer: '找情感词',
            hint: '回忆找情感线索三步',
            explanation: '找情感线索三步：①找情感词 ②看情感变化 ③连成线索。第一步是找情感词。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l3q3',
            type: 'fill',
            ...
            hint: '结尾的情感是什么',
            explanation: '《背影》情感线索：开头感伤→中间感动→结尾思念，情感层层深入。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l3q4',
            type: 'choice',
            ...
            answer: '高兴',
            hint: '哪个词直接表达情感',
            explanation: '"高兴"是直接表达情感的词语，是情感线索上的情感词。"跳了起来"是动作，"他"是人物。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l3q5',
            type: 'choice',
            ...
            answer: '贯穿全文串联情感变化',
            hint: '线索像什么一样贯穿全文',
            explanation: '情感线索贯穿全文，串联起作者情感的变化，是把握散文情感脉络的关键。这是期末常考题！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l3q6',
            type: 'drag',
            ...
            answer: '感伤,感动,思念',
            hint: '《背影》的情感是怎么层层深入的',
            explanation: '《背影》情感线索：感伤（开头）→感动（中间）→思念（结尾），层层深入。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l3q7',
            type: 'fill',
            ...
            answer: '顺',
            hint: '[记叙顺序]（五年级语文-第2单元）',
            explanation: '按事情发生发展的先后顺序来写，是顺叙，是最常用的记叙顺序。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        content: [
          ...
          { type: 'tip', content: '本课主要使用布鲁姆·创造层：通过科学方法提升学习效果', label: '教学方法', animationType: 'pulse' },
        ],
        iDo: '家长示范仿写散文片段：读一句原文，分析特点，再仿写一句。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起仿写：选一句散文，一起分析特点并仿写。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立仿写一段散文，学习名家的表达方式。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '学习表达方式和语言风格',
            hint: '仿写是模仿还是创造',
            explanation: '仿写的目的是学习名家的表达方式和语言风格，从模仿到创造，写出自己的文字。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l4q2',
            type: 'choice',
            ...
            answer: '读原文→找特点→仿写',
            hint: '先读再分析最后写',
            explanation: '仿写三步走：①读原文体会表达 ②找特点（修辞句式） ③用相同手法仿写。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l4q3',
            type: 'fill',
            ...
            hint: '学原文"偷偷地"的拟人叠词',
            explanation: '仿写学习原文"偷偷地"的拟人叠词手法，填"悄悄地"保持风格一致。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l4q4',
            type: 'choice',
            ...
            answer: '艳艳的，香香的',
            hint: '要学叠词句式',
            explanation: '"艳艳的，香香的"学习了原文"嫩嫩的，绿绿的"叠词句式，结构一致，是好的仿写。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l4q5',
            type: 'choice',
            ...
            answer: '神似——学方法写自己的感受',
            hint: '仿写是学方法还是抄内容',
            explanation: '散文仿写最重要的是"神似"——学习表达方法，用自己的观察和感受去写，而不是照抄原文内容。这是期末常考的写作要求！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l4q6',
            type: 'drag',
            ...
            answer: '读原文,找特点,仿写',
            hint: '先读再分析最后写',
            explanation: '仿写三步走：读原文（体会表达）→找特点（修辞句式）→仿写（用相同手法）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l4q7',
            type: 'fill',
            ...
            answer: '比喻',
            hint: '[修辞手法]（五年级语文-第1单元）',
            explanation: '“像”是比喻标志，把太阳比作大火球，是比喻修辞。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范检测：做一道散文鉴赏题，示范如何分析形散神聚、品味语言。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起练习：读一段散文，一起鉴赏。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立完成散文鉴赏测试，分析特点、品味语言、找情感线索。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '形散神聚',
            hint: '回忆散文特点',
            explanation: '散文最大的特点是"形散神聚"：形散（取材自由）神聚（中心统一）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l5q2',
            type: 'choice',
            ...
            answer: '优美与含蓄',
            hint: '回忆散文语言特点',
            explanation: '散文语言优美（生动形象）又含蓄（言外有意）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l5q3',
            type: 'fill',
          ...
          },
          {
            ...
            answer: '拟人',
            hint: '把小草当人写',
            explanation: '"偷偷地""钻"把小草当人写，赋予人的动作，是拟人修辞。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l5q5',
            type: 'choice',
            ...
            answer: '取材自由但中心统一',
            hint: '形散神聚的真正含义',
            explanation: '形散神聚指取材自由（形散）但中心统一（神聚），材料散落却都围绕一个中心。这是期末常考题！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l5q6',
            type: 'drag',
            ...
            explanation: '散文鉴赏步骤：找形和神→品语言→找情感线索→仿写，层层深入。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u3l5q7',
            type: 'fill',
            ...
            answer: '明',
            hint: '[修辞手法]（五年级语文-第1单元）',
            explanation: '明喻是用"像、好像、仿佛"连接本体和喻体的比喻，是五年级修辞手法学过的。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      }
    ]
    ...
    lessons: [
      {
        ...
        content: [
          ...
          { type: 'tip', content: '本课主要使用支架式：放大镜法：通过科学方法提升学习效果', label: '教学方法', animationType: 'pulse' },
        ],
        iDo: '家长示范用放大镜法写外貌细节：聚焦一个特征细致描写。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起用放大镜法写外貌，互相修改。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立用放大镜法写一段外貌细节描写。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '聚焦一个特征细致描写',
            hint: '放大镜是放大一个点',
            explanation: '放大镜法的核心是聚焦人物一个最有特点的特征，细致地描写，让人物形象鲜活。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l1q2',
            type: 'choice',
            ...
            hint: '哪句聚焦特征并用了比喻',
            explanation: '"头发像落了一层薄雪，银白发亮"聚焦白发特征并用比喻，是好的外貌细节描写。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l1q3',
            type: 'fill',
            ...
            answer: '比喻',
            hint: '用什么让描写更生动',
            explanation: '放大镜法三步：选特征、细观察、用比喻，让外貌细节描写更生动形象。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l1q4',
            type: 'choice',
            ...
            answer: '眼睛',
            hint: '描写的是哪个部位',
            explanation: '这句话聚焦"眼睛"这个特征，用"黑葡萄"比喻，是放大镜法的运用。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l1q5',
            type: 'choice',
            ...
            hint: '细节描写要聚焦还是罗列',
            explanation: '外貌细节描写不要面面俱到地罗列，而要抓住一两个最有特点的特征写细写透，效果更好。这是期末常考的写作要求！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l1q6',
            type: 'drag',
            ...
            hint: '有比喻有聚焦的是细节描写',
            explanation: '"头发像薄雪""皱纹像刀刻"有比喻有聚焦是细节描写；"是个老人""长得很老"笼统模糊是普通描写。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l1q7',
            type: 'fill',
            ...
            answer: '经过',
            hint: '[记叙文六要素]（五年级语文-第2单元）',
            explanation: '记叙文六要素中，“经过”是事情的发展过程，要作为重点写详细。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范用慢镜头法写动作：把一个动作分解成几个小动作细致描写。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起用慢镜头法写动作，互相修改。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立用慢镜头法写一段动作细节描写。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            hint: '慢镜头是把快变慢',
            explanation: '慢镜头法的核心是把一个快速动作分解成几个连续的小动作，像慢镜头一样写清楚。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l2q2',
            type: 'choice',
            ...
            hint: '哪句把动作分解了',
            explanation: '"蹬地腾空→抱球→落地缓冲"把接球分解成几个小动作，用了慢镜头法。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l2q3',
            type: 'fill',
            ...
            answer: '动词',
            hint: '什么词让动作更精准',
            explanation: '慢镜头法的关键是用好动词，动词越精准（如踱、蹿、瞄、盯）动作越生动。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l2q4',
            type: 'choice',
            ...
            hint: '要按动作的先后顺序',
            explanation: '"拿起杯子→凑到嘴边→仰头喝下→放下杯子"按动作先后顺序分解，最合理。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l2q5',
            type: 'choice',
            ...
            hint: '这个动词表现了什么状态',
            explanation: '"蹑手蹑脚"比"走"更精准地表现了小心翼翼、怕被发现的状态，动词用得准动作才生动。这是期末常考的动作描写赏析！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l2q6',
            type: 'drag',
            ...
            hint: '按动作先后顺序',
            explanation: '开门慢镜头分解：握住门把→转动门把→用力一推→门开了，按先后顺序。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l2q7',
            type: 'fill',
            ...
            answer: '心理',
            hint: '[人物描写方法]（五年级语文-第2单元）',
            explanation: '人物描写方法有外貌、语言、动作、神态、心理，多角度描写人物更生动。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        content: [
          ...
          { type: 'tip', content: '本课主要使用支架式：内心独白法：通过科学方法提升学习效果', label: '教学方法', animationType: 'pulse' },
        ],
        iDo: '家长示范写心理活动：用内心独白法写出人物心里想的话。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起写心理活动，互相修改。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立用内心独白法写一段心理细节描写。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '写出人物心里想的话',
            hint: '内心独白是心里的什么',
            explanation: '内心独白法的核心是写出人物心里想的话，让读者看到人物的内心世界。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l3q2',
            type: 'choice',
            ...
            hint: '哪句直接写心里想的话',
            explanation: '"千万别叫到我"直接写出人物心里想的话，是内心独白法。手心出汗是动作暗示，脸红是神态表现。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l3q3',
            type: 'fill',
            ...
            answer: '环境',
            hint: '用环境衬托心理',
            explanation: '心理描写四种方法：内心独白、动作暗示、神态表现、环境烘托。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l3q4',
            type: 'choice',
            ...
            answer: '动作暗示',
            hint: '咬嘴唇、绞手指是动作还是想法',
            explanation: '"咬嘴唇""绞手指"是动作，用动作表现紧张的心理，属于动作暗示。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l3q5',
            type: 'choice',
            ...
            answer: '环境烘托',
            hint: '用窗外的天气衬托心情',
            explanation: '用"窗外乌云密布"的环境来衬托人物低落的心情，属于环境烘托。这是期末常考的心理描写辨析！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l3q6',
            type: 'drag',
            ...
            explanation: '"完了完了"是心里话（内心独白），"咬嘴唇绞手指"是动作（动作暗示），"脸红眼神躲闪"是表情（神态表现）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l3q7',
            type: 'fill',
            ...
            answer: '心理',
            hint: '[人物描写方法]（五年级语文-第2单元）',
            explanation: '人物描写方法有外貌、语言、动作、神态、心理，写内心活动属于心理描写。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范用五感法写环境：调动多种感官多角度描写。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起用五感法写环境，互相补充。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立用五感法写一段环境细节描写。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            hint: '回忆五种感官',
            explanation: '五感法包括视觉（看）、听觉（听）、嗅觉（闻）、味觉（尝）、触觉（触）五种感官。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l4q2',
            type: 'choice',
            ...
            answer: '听觉',
            hint: '叽叽喳喳是听到什么',
            explanation: '"叽叽喳喳"是声音，调动的是听觉，描写听到的鸟鸣。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l4q3',
            type: 'fill',
            ...
            hint: '皮肤感受的是什么觉',
            explanation: '"微风拂过脸颊凉丝丝"是皮肤感受到的触觉，描写触摸到的感觉。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l4q4',
            type: 'choice',
            ...
            answer: '空气中飘来淡淡的花香',
            hint: '闻到的是什么',
            explanation: '"淡淡的花香"是鼻子闻到的气味，调动了嗅觉。光影是视觉，甜味是味觉。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l4q5',
            type: 'choice',
            ...
            hint: '五感必须全用吗',
            explanation: '用五感法描写环境不必五感全用，根据环境特点选2-3种最突出的感官来写，效果更好。这是期末常考的写作要求！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l4q6',
            type: 'drag',
            ...
            hint: '看、听、闻分别对应什么',
            explanation: '"斑驳光影"是看到的（视觉），"鸟儿唱歌"是听到的（听觉），"淡淡花香"是闻到的（嗅觉）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l4q7',
            type: 'fill',
            ...
            explanation: '写景要有顺序，常用由远到近、由整体到局部、由上到下等。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范写细节记叙文：综合运用多种细节描写写一段。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起修改：互相修改对方作文中的细节描写。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立写500字记叙文，含3种以上细节描写。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '放大镜法',
            hint: '回忆四种细节描写方法',
            explanation: '外貌细节用放大镜法（聚焦特征），动作用慢镜头法，心理用内心独白法，环境用五感法。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l5q2',
            type: 'choice',
            ...
            answer: '慢镜头法',
            hint: '把动作分解的方法',
            explanation: '动作细节用慢镜头法：把一个动作分解成几个小动作细致描写。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l5q3',
            type: 'fill',
            ...
            answer: '五感',
            hint: '看听闻尝触',
            explanation: '环境细节用五感法：调动视觉、听觉、嗅觉、味觉、触觉多角度描写。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l5q4',
            type: 'choice',
            ...
            answer: '为表现中心服务',
            hint: '细节的作用是什么',
            explanation: '细节描写要为表现文章中心服务，不能为细节而细节，要恰到好处。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l5q5',
            type: 'choice',
            ...
            hint: '找既有动作又有心理的',
            explanation: '"咬着嘴唇"是动作细节，"心想：完了完了"是心理细节，一句话同时用了两种细节描写。这是期末常考的细节辨析题！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l5q6',
            type: 'drag',
            ...
            hint: '回忆四种细节描写各自的方法',
            explanation: '外貌用放大镜法，动作用慢镜头法，心理用内心独白法，环境用五感法。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u4l5q7',
            type: 'fill',
            ...
            explanation: '记叙文描写方法有外貌、语言、动作、心理描写，动作描写是把动作分解写清楚，是五年级学过的。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      }
    ]
    ...
    lessons: [
      {
        ...
        iDo: '家长读"不识庐山真面目"引出哲理，示范如何从诗句中体会人生道理。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起讨论哲理诗句的含义和生活启示。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立找一首哲理诗，说出其中的哲理。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '当局者迷，旁观者清',
            hint: '身在山中看不清全貌说明什么',
            explanation: '身在山中反而看不清庐山全貌，哲理是：当局者迷，旁观者清，要全面认识事物需跳出局限。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l1q2',
            type: 'choice',
            ...
            answer: '站得高才能看得远',
            hint: '更上一层楼才能看更远',
            explanation: '"欲穷千里目，更上一层楼"哲理是：站得高才能看得远，要不断进取才能有更广阔的视野。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l1q3',
            type: 'fill',
            ...
            answer: '苏轼',
            hint: '这首诗的作者是谁',
            explanation: '《题西林壁》的作者是宋代诗人苏轼。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l1q4',
            type: 'choice',
            ...
            answer: '绝境中往往有转机',
            hint: '疑无路后又见村庄说明什么',
            explanation: '"山重水复疑无路，柳暗花明又一村"哲理是：绝境中往往有转机，不要轻易放弃希望。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l1q5',
            type: 'choice',
            ...
            answer: '新事物必将取代旧事物',
            hint: '沉舟旁千帆过，病树前万木春',
            explanation: '"沉舟侧畔千帆过，病树前头万木春"哲理是：新事物必将取代旧事物，事物总是向前发展的。这是期末常考的哲理诗赏析！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l1q6',
            type: 'drag',
            ...
            hint: '想想每句诗的哲理',
            explanation: '"更上一层楼"=站得高看得远；"不识真面目"=当局者迷；"柳暗花明又一村"=绝境有转机。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l1q7',
            type: 'fill',
            ...
            explanation: '“欲穷千里目，更上一层楼”出自五年级古诗《登鹳雀楼》，寓意向高处看要再登高。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长读诗作画体会意境：示范如何想象画面、体会情感、感受意境。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起读诗画画面，互相讨论意境。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立画画面并体会意境。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '画面与情感',
            hint: '回忆意境的构成',
            explanation: '意境由画面（诗中景象）和情感（诗人感情）融合而成，画面+情感=意境。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l2q2',
            type: 'choice',
            ...
            answer: '画面（景物）',
            hint: '明月光是景物还是情感',
            explanation: '"床前明月光"描绘了明月和霜光等景物，属于意境中的画面部分。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l2q3',
            type: 'fill',
            ...
            hint: '低头思的是什么',
            explanation: '《静夜思》"低头思故乡"表达了诗人思念故乡的思乡之情。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l2q4',
            type: 'choice',
            ...
            answer: '找景物',
            hint: '回忆想象画面三步',
            explanation: '读诗想象画面三步：①找景物 ②想画面 ③悟情感。第一步是找景物。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l2q5',
            type: 'choice',
            ...
            answer: '清冷孤寂的思乡之情',
            hint: '明月霜光的画面配思乡的情感',
            explanation: '《静夜思》明月霜光的清冷画面，加上思乡的孤寂情感，意境是"清冷孤寂的思乡之情"。这是期末常考的意境赏析！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l2q6',
            type: 'drag',
            ...
            hint: '景物是画面，感情是情感',
            explanation: '"明月霜光""举头望月"是景物画面；"思故乡""思乡之情"是感情情感。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l2q7',
            type: 'fill',
            ...
            answer: '霜',
            hint: '[古诗名句]（五年级语文-第5单元）',
            explanation: '李白《静夜思》"床前明月光，疑是地上霜"，用霜比喻月光，是五年级学过的名句。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长读文言文+逐句翻译，示范如何理解文言文。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起翻译短篇文言文，互相检查。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立翻译短篇文言文。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '跑',
            hint: '古文中"走"和现在意思不同',
            explanation: '"走"在古文中是"跑"的意思，古今异义。"兔走触株"是兔子跑过来撞到树桩。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l3q2',
            type: 'choice',
            ...
            answer: '放下',
            hint: '在这里"释"是什么动作',
            explanation: '"释"在这里是"放下"的意思。"因释其耒"是于是放下农具。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l3q3',
            type: 'fill',
            ...
            answer: '希望',
            hint: '农夫守株是为了什么',
            explanation: '"冀"是"希望"的意思。"冀复得兔"是希望能再捡到兔子。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l3q4',
            type: 'choice',
            ...
            answer: '不能心存侥幸，要靠劳动',
            hint: '农夫守株的结果是什么',
            explanation: '《守株待兔》告诉我们不能心存侥幸，不能把偶然当成必然，要靠自己的劳动。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l3q5',
            type: 'choice',
            ...
            hint: '注意"走"的古义',
            explanation: '"兔走触株，折颈而死"翻译为"兔子跑来撞到树桩，折断脖子死了"。注意"走"古义是"跑"。这是期末常考的文言文翻译！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l3q6',
            type: 'drag',
            ...
            hint: '回忆重点字词的古义',
            explanation: '走=跑，释=放下，耒=农具，冀=希望，这些都是文言文重点字词。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l3q7',
            type: 'fill',
            ...
            explanation: '孟浩然《春晓》"春眠不觉晓，处处闻啼鸟"，是五年级学过的古诗。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范默写+运用闪卡：默写名句，示范在情境中运用诗句。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起做默写和运用练习。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立默写名句并在情境中运用。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '举',
            hint: '哪个字笔画多容易错',
            explanation: '"举"字笔画较多，容易写成"具"等错别字，默写时要特别注意。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l4q2',
            type: 'choice',
            ...
            answer: '欲穷千里目，更上一层楼',
            hint: '哪句诗表达上进的意思',
            explanation: '"欲穷千里目，更上一层楼"哲理是站得高看得远，鼓励人不断进取，最合适。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l4q3',
            type: 'fill',
            ...
            answer: '因为',
            hint: '"只缘"就是"只因为"',
            explanation: '"缘"在这里是"因为"的意思。"只缘身在此山中"是只因为身在这座山里。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l4q4',
            type: 'choice',
            ...
            hint: '哪句诗表达困境有转机',
            explanation: '"山重水复疑无路，柳暗花明又一村"哲理是绝境中有转机，最适合安慰遇到困难的朋友。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l4q5',
            type: 'choice',
            ...
            answer: '欲穷千里目',
            hint: '注意"目"和"千"的字形',
            explanation: '正确默写是"欲穷千里目，更上一层楼"。"目"是眼睛，不能写成"木"。这是期末常考的默写题！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l4q6',
            type: 'drag',
            ...
            hint: '想想每句诗适合什么情境',
            explanation: '鼓励上进用"欲穷千里目"，全面看问题用"不识庐山真面目"，困境有转机用"柳暗花明又一村"。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l4q7',
            type: 'fill',
            ...
            answer: '晖',
            hint: '[古诗名句]（五年级语文-第5单元）',
            explanation: '孟郊《游子吟》"谁言寸草心，报得三春晖"，表达母爱，是五年级学过的名句。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范检测：做一道古诗文题，示范默写、理解、运用。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起练习古诗文默写和理解。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立完成古诗文测试，默写+理解+运用。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '当局者迷，旁观者清',
            hint: '身在山中看不清全貌',
            explanation: '"不识庐山真面目"哲理是当局者迷，旁观者清，要全面认识事物需跳出局限。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l5q2',
            type: 'choice',
            ...
            answer: '画面与情感',
            hint: '回忆意境的构成',
            explanation: '意境由画面（诗中景象）和情感（诗人感情）融合而成。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l5q3',
            type: 'fill',
            ...
            answer: '跑',
            hint: '古今异义词',
            explanation: '文言文中"走"是"跑"的意思，是古今异义词。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l5q4',
            type: 'choice',
            ...
            answer: '鼓励人上进',
            hint: '这句诗的哲理是什么',
            explanation: '"欲穷千里目，更上一层楼"哲理是站得高看得远，适合鼓励人不断上进。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l5q5',
            type: 'choice',
            ...
            answer: '山重水复疑无路',
            hint: '注意原句的字词',
            explanation: '正确默写是"山重水复疑无路，柳暗花明又一村"。这是期末常考的默写题！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l5q6',
            type: 'drag',
            ...
            hint: '景物是画面，感情是情感',
            explanation: '"明月霜光""举头望月"是景物画面；"思乡之情""思故乡"是感情情感。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u5l5q7',
            type: 'fill',
            ...
            answer: '故乡',
            hint: '[古诗文鉴赏]（五年级语文-第5单元）',
            explanation: '李白《静夜思》"举头望明月，低头思故乡"表达思乡之情，是五年级古诗文鉴赏学过的。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      }
    ]
    ...
    lessons: [
      {
        ...
        content: [
          ...
          { type: 'tip', content: '本课主要使用成长型思维：鼓励孩子相信努力练习带来进步', label: '教学方法', animationType: 'pulse' },
        ],
        iDo: '家长示范制作成长纪念册：展示如何选故事、配照片、写感受。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起策划成长纪念册，挑选照片和故事。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立制作成长纪念册，写成长故事。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '论点论据',
            hint: '论点论据是哪种文体的要素',
            explanation: '成长故事要素：时间、地点、人物、事件、感受。论点论据是议论文的要素，不需要。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l1q2',
            type: 'choice',
            ...
            answer: '数学公式',
            hint: '纪念册里放什么',
            explanation: '成长纪念册由封面+目录+照片+故事+感受组成，数学公式不属于纪念册内容。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l1q3',
            type: 'fill',
            ...
            answer: '感受',
            hint: '故事最后要写什么',
            explanation: '成长故事要素：时间、地点、人物、事件、感受，感受是表达自己的感想。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l1q4',
            type: 'choice',
            ...
            answer: '写出真情实感',
            hint: '什么让故事打动人',
            explanation: '写成长故事最重要的是写出真情实感，让读者感受到你的成长和快乐，而不是追求字数或辞藻。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l1q5',
            type: 'choice',
            ...
            answer: '选最难忘的事写出真情实感',
            hint: '故事要选什么来写',
            explanation: '成长故事要选最难忘的事来写，写出真情实感，而不是罗列所有事情。这是期末常考的写作要求！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l1q6',
            type: 'drag',
            ...
            explanation: '时间=三年级，地点=操场，人物=我和同学，事件=运动会获奖，感受=很自豪。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l1q7',
            type: 'fill',
            ...
            answer: '结果',
            hint: '[记叙文六要素]（五年级语文-第2单元）',
            explanation: '记叙文六要素：时间、地点、人物、起因、经过、结果，是五年级记叙文进阶学过的基础。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范写信：按格式写一封给未来自己的信。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起讨论写信内容，互相启发。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立写一封给未来自己的信。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            hint: '回忆书信六部分',
            explanation: '书信格式顺序：称呼→问候→正文→祝福→署名→日期。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l2q2',
            type: 'choice',
            ...
            answer: '顶格写加冒号',
            hint: '称呼的位置和标点',
            explanation: '称呼要顶格写，后面加冒号，如"未来的我："。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l2q3',
            type: 'fill',
            ...
            hint: '第三部分写什么',
            explanation: '写信内容三部分：现在的我、我的期望、我的梦想（未来梦想和计划）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l2q4',
            type: 'choice',
            ...
            answer: '右下角，署名在上日期在下',
            hint: '回忆署名日期的位置',
            explanation: '署名和日期写在右下角，署名在上，日期在署名下方。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l2q5',
            type: 'choice',
            ...
            hint: '回忆书信各部分格式',
            explanation: '书信格式：称呼顶格写加冒号，问候和正文空两格写，祝福空两格，署名日期在右下角。这是期末常考的书信格式！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l2q6',
            type: 'drag',
            ...
            answer: '称呼,问候,正文,祝福,署名,日期',
            hint: '从上到下的顺序',
            explanation: '书信顺序：称呼→问候→正文→祝福→署名→日期。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l2q7',
            type: 'fill',
            ...
            explanation: '日记格式先写日期、星期、天气，再写正文，是五年级应用文写作学过的。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范毕业演讲：读一篇演讲稿，示范回忆、感谢、展望三部分。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起练习演讲，互相提建议。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立写并演讲一篇毕业演讲稿。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '回忆、感谢、展望',
            hint: '回忆小学，感谢师长，展望未来',
            explanation: '毕业演讲三部分：回忆（小学美好回忆）、感谢（感谢老师同学）、展望（对未来的期待）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l3q2',
            type: 'choice',
            ...
            answer: '称呼',
            hint: '演讲开头先叫谁',
            explanation: '演讲稿开头要有称呼，如"敬爱的老师、亲爱的同学们"。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l3q3',
            type: 'fill',
            ...
            hint: '除了同学还要感谢谁',
            explanation: '毕业演讲的"感谢"部分主要感谢老师的教导和同学的陪伴。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l3q4',
            type: 'choice',
            ...
            answer: '真情实感',
            hint: '什么让演讲打动人',
            explanation: '毕业演讲最重要的是真情实感，发自内心的感受才能打动听众。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l3q5',
            type: 'choice',
            ...
            hint: '两种文体的核心目的不同',
            explanation: '毕业演讲稿以抒情表达感情为主，议论文以说理说服别人为主，这是两者最大的区别。这是期末常考的文体辨析！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l3q6',
            type: 'drag',
            ...
            answer: '回忆,感谢,展望',
            hint: '先回忆再感谢最后展望',
            explanation: '毕业演讲三部分顺序：回忆（过去）→感谢（现在）→展望（未来）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l3q7',
            type: 'fill',
            ...
            answer: '顶',
            hint: '[应用文写作]（五年级语文-第7单元）',
            explanation: '书信格式中"此致"空两格写，"敬礼"顶格写，是五年级应用文写作学过的。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范分工合作：展示如何分工、如何协调各部分。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起制作纪念册，分工合作。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立完成个人负责的部分。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '数学竞赛',
            hint: '哪项和制作纪念册无关',
            explanation: '小组分工包括封面设计、文章撰写、照片整理、装饰美化。数学竞赛与制作纪念册无关。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l4q2',
            type: 'choice',
            ...
            hint: '回忆合作三原则',
            explanation: '合作三原则：明确分工、互相帮助、统一风格，这样才能高效合作。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l4q3',
            type: 'fill',
            ...
            answer: '年份',
            hint: '封面上除了标题还有什么',
            explanation: '纪念册封面包括标题和毕业年份，如"2026届毕业纪念册"。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l4q4',
            type: 'choice',
            ...
            answer: '互相帮助一起解决',
            hint: '合作三原则之一',
            explanation: '遇到困难要互相帮助一起解决，这是合作三原则之一，不能放弃或指责队友。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l4q5',
            type: 'choice',
            ...
            answer: '合理分工，互相配合',
            hint: '合作的关键是什么',
            explanation: '小组合作最重要的是合理分工、互相配合，发挥各自所长，才能高效完成。这是期末常考的合作理念！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l4q6',
            type: 'drag',
            ...
            hint: '从开头到结尾的顺序',
            explanation: '纪念册结构：封面→目录→成长故事→同学留言→封底。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l4q7',
            type: 'fill',
            ...
            answer: '单位',
            hint: '[应用文写作]（五年级语文-第7单元）',
            explanation: '通知格式：标题→正文（事由+时间+地点+要求）→发文单位→日期，是五年级应用文写作学过的。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        content: [
          ...
          { type: 'tip', content: '本课主要使用综合展示：通过科学方法提升学习效果', label: '教学方法', animationType: 'pulse' },
        ],
        iDo: '家长示范展示：展示如何自信地展示纪念册和发表演讲。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起练习展示，互相鼓励。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立展示成长纪念册并发表演讲。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '参加考试',
            hint: '哪项和分享会无关',
            explanation: '毕业分享会包括展示纪念册、发表演讲、互赠留言等。参加考试与分享会无关。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l5q2',
            type: 'choice',
            ...
            answer: '自信大方、声音洪亮',
            hint: '回忆展示小贴士',
            explanation: '展示时要自信大方、抬头挺胸、声音洪亮、表达清楚，这样才能展示出最好的自己。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l5q3',
            type: 'fill',
            ...
            answer: '演讲',
            hint: '除了纪念册还有什么',
            explanation: '毕业分享会主要展示成长纪念册和发表毕业演讲。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l5q4',
            type: 'choice',
            ...
            hint: '分享会的真正目的',
            explanation: '毕业分享会的意义是分享六年收获、感恩老师同学、展望美好未来，是小学最难忘的时刻。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l5q5',
            type: 'choice',
            ...
            answer: '感恩真诚',
            hint: '什么态度最打动人',
            explanation: '毕业演讲最应体现感恩真诚的态度，真心感谢老师同学，这样才最打动人。这是期末常考的表达要求！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l5q6',
            type: 'drag',
            ...
            hint: '从开始到结束的顺序',
            explanation: '分享会流程：开场→纪念册展示→毕业演讲→同学留言→合影留念。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u6l5q7',
            type: 'fill',
            ...
            answer: '称呼',
            hint: '[应用文写作]（五年级语文-第7单元）',
            explanation: '请假条格式：称呼→正文（请假原因+时间）→此致敬礼→署名→日期，是五年级应用文写作学过的。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      }
    ]
    ...
    lessons: [
      {
        ...
        iDo: '家长对比文言和白话：逐句对比，让孩子看清文言文简洁的特点。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起对比：给一段文言文，一起说出现代文意思。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立辨认文言文特点，说出与现代文的不同。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '简洁凝练',
            hint: '文言文用字少意思全',
            explanation: '文言文最突出的特点是简洁凝练，用很少的字表达完整的意思。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l1q2',
            type: 'choice',
            ...
            answer: '跑',
            hint: '古今异义词',
            explanation: '文言文中"走"是"跑"的意思，与现在的"步行"不同，是古今异义词。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l1q3',
            type: 'fill',
            ...
            answer: '学习',
            hint: '单音节词对应双音节词',
            explanation: '文言文单音节词"学"对应现代文双音节词"学习"。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l1q4',
            type: 'choice',
            ...
            answer: '简洁凝练',
            hint: '文言文用字少还是多',
            explanation: '文言文"学而时习之，不亦说乎"比现代文简洁很多，体现了文言文简洁凝练的特点。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l1q5',
            type: 'choice',
            ...
            answer: '句子很长很啰嗦',
            hint: '文言文是简洁还是啰嗦',
            explanation: '文言文特点是简洁凝练、单音节词多、有特殊句式。"句子很长很啰嗦"不是文言文特点。这是期末常考的文言文常识！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l1q6',
            type: 'drag',
            ...
            hint: '单音节词对应双音节词',
            explanation: '学=学习，走=跑，日=太阳，妻=妻子，都是文言单音节词对应现代双音节词。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l1q7',
            type: 'fill',
            ...
            answer: '悯农',
            hint: '[古诗文鉴赏]（五年级语文-第5单元）',
            explanation: '《悯农》是五年级学习的古诗，“锄禾日当午，汗滴禾下土”写农民劳作辛苦。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范常见实词的意思：逐个讲解实词古义和今义。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起记实词，互相考问。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立翻译实词，说出古义和今义。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '离开',
            hint: '古今异义词',
            explanation: '"去"在文言文中古义是"离开"，今义是"前往"，是古今异义词。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l2q2',
            type: 'choice',
            ...
            answer: '妻子和儿女',
            hint: '古义比今义范围大',
            explanation: '"妻"在古文中意思是"妻子和儿女"，比今义"妻子"范围更大。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l2q3',
            type: 'fill',
            ...
            answer: '跑',
            hint: '兔子怎么撞树桩的',
            explanation: '"兔走触株"中"走"古义是"跑"，兔子跑来撞到树桩。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l2q4',
            type: 'choice',
            ...
            answer: '山（古今义相同）',
            hint: '哪个词古今意思没变',
            explanation: '"山"古今义相同都是山。"走"古义跑今义步行，"去"古义离开今义前往，都不同。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l2q5',
            type: 'choice',
            ...
            answer: '太丘离开',
            hint: '注意"去"的古义',
            explanation: '"去"古义是"离开"，"太丘舍去"翻译为"太丘放下（东西）离开了"。这是期末常考的实词翻译！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l2q6',
            type: 'drag',
            ...
            hint: '回忆常见实词古义',
            explanation: '走=跑，去=离开，妻=妻子和儿女，子=孩子，都是常见实词的古义。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l2q7',
            type: 'fill',
            ...
            answer: '故乡',
            hint: '[古诗名句]（五年级语文-第5单元）',
            explanation: '《静夜思》中“举头望明月，低头思故乡”，思故乡表达思乡之情。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范虚词用法：逐个讲解之乎者也的用法和例句。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起辨析虚词，互相考问。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立判断虚词用法。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '的',
            hint: '古（的）学者',
            explanation: '"古之学者"中"之"是"的"的意思，表修饰关系，"古之学者"即"古代的学者"。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l3q2',
            type: 'choice',
            ...
            answer: '代词（他/它）',
            hint: '温习什么',
            explanation: '"学而时习之"中"之"是代词，代指学过的知识，"温习它"。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l3q3',
            type: 'fill',
            ...
            hint: '我想___南海',
            explanation: '"吾欲之南海"中"之"是动词"去/往"的意思，"我想去南海"。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l3q4',
            type: 'choice',
            ...
            answer: '表疑问或感叹',
            hint: '乎是语气词',
            explanation: '"不亦说乎"中"乎"是语气词，表疑问或感叹，"不也很愉快吗"。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l3q5',
            type: 'choice',
            ...
            answer: '的人',
            hint: '耕者是什么人',
            explanation: '"者"意思是"……的人"，"耕者"即"种田的人"。这是期末常考的虚词用法！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l3q6',
            type: 'drag',
            ...
            hint: '回忆之字三用法',
            explanation: '"古之学者"之=的；"学而时习之"之=代词；"吾欲之南海"之=去往。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l3q7',
            type: 'fill',
            ...
            answer: '动',
            hint: '[古诗文鉴赏]（五年级语文-第5单元）',
            explanation: '王安石《泊船瓜洲》"春风又绿江南岸"中"绿"是形容词用作动词，表示"吹绿了"，是五年级古诗文鉴赏学过的。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长读《揠苗助长》+逐句翻译，示范如何读懂文言短文。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起翻译，互相检查字词理解。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立翻译《揠苗助长》并说出感悟。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '拔',
            hint: '农夫对禾苗做了什么',
            explanation: '"揠"是"拔"的意思。"揠苗"就是把禾苗拔高。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l4q2',
            type: 'choice',
            ...
            answer: '担心',
            hint: '农夫对禾苗不长是什么心情',
            explanation: '"闵"是"担心"的意思。"闵其苗之不长"是担心禾苗长得慢。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l4q3',
            type: 'fill',
            ...
            hint: '禾苗被拔后怎么了',
            explanation: '"槁"是"枯萎"的意思。"苗则槁矣"是禾苗已经枯萎了。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l4q4',
            type: 'choice',
            ...
            hint: '拔苗的结果是什么',
            explanation: '《揠苗助长》告诉我们做事不能急于求成、违背客观规律，否则会适得其反，害了事物。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l4q5',
            type: 'choice',
            ...
            answer: '疲惫地回到家',
            hint: '芒芒然是什么样子',
            explanation: '"芒芒然"是疲惫的样子，"芒芒然归"翻译为"疲惫地回到家"。这是期末常考的文言文翻译！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l4q6',
            type: 'drag',
            ...
            hint: '回忆重点字词',
            explanation: '揠=拔，闵=担心，槁=枯萎，趋=快走，都是《揠苗助长》的重点字词。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l4q7',
            type: 'fill',
            ...
            answer: '春雨',
            hint: '[古诗文鉴赏]（五年级语文-第5单元）',
            explanation: '杜甫《春夜喜雨》"随风潜入夜，润物细无声"描写春雨，是五年级古诗文鉴赏学过的。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范检测：做一道文言文翻译题，示范如何理解字词、翻译句子。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起练习文言文翻译。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立完成文言文测试，翻译句子、理解字词。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '简洁凝练',
            hint: '回忆文言文特点',
            explanation: '文言文最突出的特点是简洁凝练，用很少的字表达完整意思。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l5q2',
            type: 'choice',
            ...
            answer: '跑',
            hint: '古今异义实词',
            explanation: '"走"在文言文中古义是"跑"，今义是"步行"，是古今异义实词。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l5q3',
            type: 'fill',
            ...
            answer: '的',
            hint: '古（的）学者',
            explanation: '"古之学者"中"之"是"的"的意思，表修饰关系。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l5q4',
            type: 'choice',
          ...
          },
          {
            ...
            answer: '代词（他/它）',
            hint: '温习什么',
            explanation: '"学而时习之"中"之"是代词，代指学过的知识，"温习它"。这是期末常考的虚词用法！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l5q6',
            type: 'drag',
            ...
            hint: '回忆实词古义',
            explanation: '走=跑，去=离开，揠=拔，闵=担心，都是文言文常见字词的古义。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u7l5q7',
            type: 'fill',
            ...
            answer: '抬',
            hint: '[古诗文鉴赏]（五年级语文-第5单元）',
            explanation: '"举头"即抬头，"举"是"抬"的意思，是五年级古诗文鉴赏学过的字词理解。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      }
    ]
    ...
    lessons: [
      {
        ...
        content: [
          ...
          { type: 'tip', content: '本课主要使用综合复习：通过科学方法提升学习效果', label: '教学方法', animationType: 'pulse' },
        ],
        iDo: '家长示范判断文体：读片段，示范如何判断文体并选用阅读方法。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起判断文体，互相讨论。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立判断文体并选用阅读方法。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '说明文',
            hint: '介绍事物特征的是什么文体',
            explanation: '介绍鲸鱼的特征和知识，属于说明文（以知启人）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l1q2',
            type: 'choice',
            ...
            answer: '以理服人',
            hint: '议论文用什么说服人',
            explanation: '议论文的核心是以理服人——讲道理、说服别人。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l1q3',
            type: 'fill',
            ...
            answer: '环境',
            hint: '回忆小说三要素',
            explanation: '小说三要素：人物（核心）、情节（骨架）、环境（背景）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l1q4',
            type: 'choice',
            ...
            answer: '形散神聚',
            hint: '散文的标志性特点',
            explanation: '散文最大的特点是"形散神聚"：取材自由（形散）中心统一（神聚）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l1q5',
            type: 'choice',
            ...
            answer: '议论文',
            hint: '提出观点并说理的是什么文体',
            explanation: '"读书有益，我们应该多读书"提出观点并说理，属于议论文（以理服人）。这是期末常考的文体判断！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l1q6',
            type: 'drag',
            ...
            hint: '回忆各类文体特点',
            explanation: '记叙文以事感人，说明文以知启人，议论文以理服人，散文形散神聚。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l1q7',
            type: 'fill',
            ...
            answer: '起因',
            hint: '[记叙文六要素]（五年级语文-第2单元）',
            explanation: '记叙文六要素：时间、地点、人物、起因、经过、结果，其中起因和经过最关键，是五年级学过的。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范审题写作：根据题目判断文体，示范写作过程。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起审题构思，互相讨论。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立审题并写一篇指定文体的作文。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '记叙文',
            hint: '写一件事适合什么文体',
            explanation: '"我难忘的一件事"要求叙述事件，适合写成记叙文，写清六要素和细节。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l2q2',
            type: 'choice',
            ...
            answer: '我认为……因为……所以……',
            hint: '回忆议论模板',
            explanation: '议论文模板："我认为（论点）……因为（论据）……所以（结论）……"。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l2q3',
            type: 'fill',
            ...
            answer: '构思',
            hint: '审题之后写作之前做什么',
            explanation: '写作三步走：审题（看清要求）→构思（列提纲）→写作（写并修改）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l2q4',
            type: 'choice',
            ...
            hint: '记叙文的关键是什么',
            explanation: '写记叙文最重要的是六要素齐全、细节描写生动、有真情实感。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l2q5',
            type: 'choice',
            ...
            answer: '审题看清题目要求和文体',
            hint: '写作三步的第一步',
            explanation: '写作第一步是审题，看清题目要求和文体，再构思和写作。这是期末常考的写作要求！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l2q6',
            type: 'drag',
            ...
            hint: '根据题目判断文体',
            explanation: '"一件事"是记叙文，"读书有益"是议论文，"校园的春天"是散文。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l2q7',
            type: 'fill',
            ...
            explanation: '说明方法有列数字、作比较、打比方、举例子等，打比方就是用比喻说明，是五年级说明文写作学过的。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范古诗文复习：默写名句，示范翻译和理解。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起默写和翻译古诗文。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立默写、翻译、运用古诗文。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '当局者迷，旁观者清',
            hint: '身在山中看不清全貌',
            explanation: '"不识庐山真面目"哲理是当局者迷，旁观者清。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l3q2',
            type: 'choice',
            ...
            answer: '目（易写成木）',
            hint: '哪个字最易写错',
            explanation: '"目"容易写成"木"，默写时要特别注意。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l3q3',
            type: 'fill',
            ...
            answer: '跑',
            hint: '古今异义词',
            explanation: '文言文中"走"古义是"跑"，今义是"步行"。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l3q4',
            type: 'choice',
            ...
            answer: '山重水复疑无路，柳暗花明又一村',
            hint: '哪句诗表达困境有转机',
            explanation: '"山重水复疑无路，柳暗花明又一村"哲理是困境中有转机，最适合安慰朋友。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l3q5',
            type: 'choice',
            ...
            answer: '做事不能急于求成、违背规律',
            hint: '拔苗的结果是什么',
            explanation: '《揠苗助长》告诉我们做事不能急于求成、违背客观规律，否则适得其反。这是期末常考的文言文感悟！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l3q6',
            type: 'drag',
            ...
            hint: '回忆每句诗的哲理',
            explanation: '"不识庐山真面目"=当局者迷，"欲穷千里目"=站得高看得远，"柳暗花明又一村"=困境有转机。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l3q7',
            type: 'fill',
            ...
            answer: '因为',
            hint: '[古诗文鉴赏]（五年级语文-第5单元）',
            explanation: '杜牧《山行》"停车坐爱枫林晚"中"坐"是"因为"的意思，不是"坐下"，是五年级古诗文鉴赏学过的。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长示范模拟答题：做一道阅读理解，示范审题、找答案、组织答案。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起做模拟题，互相讨论。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子独立完成小升初模拟测试。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '先审题看清要求',
            hint: '考试小贴士第一条',
            explanation: '考试第一步是先审题，看清题目要求再作答，避免答非所问。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l4q2',
            type: 'choice',
            ...
            answer: '带着问题在文中找答案',
            hint: '回忆阅读答题法',
            explanation: '阅读理解答题要带着问题读文章，在文中找答案，再用自己的话组织。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l4q3',
            type: 'fill',
            ...
            answer: '作文',
            hint: '第四种题型是什么',
            explanation: '小升初模拟题型：文体判断、阅读理解、古诗文默写、作文。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l4q4',
            type: 'choice',
            ...
            answer: '议论文',
            hint: '用了议论模板的是什么文体',
            explanation: '用了"我认为……因为……所以……"议论模板，属于议论文表达。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l4q5',
            type: 'choice',
            ...
            hint: '回忆阅读答题法',
            explanation: '阅读理解正确答题方法：带着问题读文章，在文中找答案，再用自己话组织。这是期末常考的答题方法！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l4q6',
            type: 'drag',
            ...
            hint: '考试的四步顺序',
            explanation: '考试小贴士：先审题→抓要点→写完整→查一遍。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l4q7',
            type: 'fill',
            ...
            explanation: '"大概"和"一定"矛盾，应删去"大概"，是五年级综合测评学过的病句修改。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      },
      {
        ...
        iDo: '家长主持毕业典礼：回顾六年收获，颁发"毕业证书"。 【CFU检查理解】家长问"这个字读什么？"',
        weDo: '【引导式】亲子一起回顾六年语文学习的收获和成长。 → 【半独立】孩子说步骤家长做 → 【独立】孩子自己做',
        youDo: '孩子完成综合测评，参加毕业典礼。【费曼小老师时间】用最简单的话把今天学的讲给小熊/家长听，讲不清的地方回去看一遍再讲。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '解数学方程',
            hint: '哪项不是语文能力',
            explanation: '六年语文学习包括阅读写作、古诗文文言文、表达等能力。解数学方程是数学能力，不属于语文。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l5q2',
            type: 'choice',
            ...
            answer: '论点、论据、论证',
            hint: '回忆议论文三要素',
            explanation: '议论文三要素：论点（主张）、论据（理由证据）、论证（证明过程）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l5q3',
            type: 'fill',
          ...
          },
          {
            ...
            answer: '拥有了阅读写作表达的能力',
            hint: '什么能力最重要',
            explanation: '六年语文学习最重要的收获是拥有了阅读、写作、表达的能力，这些能力终身受用。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l5q5',
            type: 'choice',
            ...
            hint: '六年语文学习的全面收获',
            explanation: '六年语文学习学会了阅读各类文体、写作各类文体、理解古诗文和文言文，收获全面而丰富。这是毕业总结的核心！做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l5q6',
            type: 'drag',
            ...
            hint: '六年语文五大能力',
            explanation: '六年语文五大能力：阅读（各类文体）、写作（各类文体）、古诗（默写运用）、文言（翻译理解）、表达（演讲书信）。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          },
          {
            id: 'c6u8l5q7',
            type: 'fill',
            ...
            answer: '剪刀',
            hint: '[古诗文鉴赏]（五年级语文-第5单元）',
            explanation: '贺知章《咏柳》"二月春风似剪刀"把春风比作剪刀，是五年级古诗文鉴赏学过的名句。做错是因为这个方法还不熟练，多练几次就好，不是你不够聪明。'
          }
        ]
      }
    ]
