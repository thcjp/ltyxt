...
{ type: 'text', content: '早晨，从山坡上，从坪坝里，从一条条开着绒球花和太阳花的小路上，走来了许多小学生', animationType: 'reveal' },
        ...
        learningObjective: '我能理解课文《大青树下的小学》的主要内容并体会作者情感',
        successCriteria: '①能概括课文主要内容 ②能体会作者表达的情感',
        iDo: '家长朗读课文，在描写学校特色的句子处停顿，引导孩子关注细节描写。',
        weDo: '亲子一起比较这所学校和自己学校的异同，说说各自学校的特色。',
        youDo: '孩子独立朗读课文，找出描写民族特色的句子并摘抄。',
        parentTips: '【家长预习】坝(bà)偏旁：土本义：拦水的堤引申义：大坝、堤坝组词：…\n共学四步：\n①对话出题：问孩子"大青树下的小学有什么特别之处？"\n②孩子应答：这所小学有不同民族的同学一起上学，这是它最特别的地方。\n③答错引导：家长可以教孩子用"找关键词法"——回到课文找关键句子定位答案\n④快速检测：大青树下的小学有什么特别之处？、同学们穿戴（    ），来到学校、按课文顺序排列学校一天的活动',
...
{ type: 'text', content: '雷云在天上轰响，六月的阵雨落下的时候，一群一群的花从无人知道的地方突然跑出来，在绿草上跳着狂欢的舞', animationType: 'reveal' },
        ...
        learningObjective: '我能理解课文《花的学校》的主要内容并体会作者情感',
        successCriteria: '①能概括课文主要内容 ②能体会作者表达的情感',
        iDo: '家长朗读课文，用丰富的语气表现花孩子们在地下学校上课、下雨时跑出来的场景。',
        weDo: '亲子一起想象：如果你是花孩子，在地下学校会学什么？跑出来后会做什么？',
        youDo: '孩子独立朗读课文，找出自己最喜欢的想象句子并背诵。',
        parentTips: '【家长预习】荒(huāng)偏旁：艹本义：荒芜引申义：荒野、荒凉组词…\n共学四步：\n①对话出题：问孩子"花的学校"的作者是谁？"\n②孩子应答：《花的学校》作者是印度诗人泰戈尔，他写过很多优美的诗歌。\n③答错引导：家长可以教孩子用"找关键词法"——回到课文找关键句子定位答案\n④快速检测："花的学校"的作者是谁？、花孩子们在（    ）学校上课、花孩子们什么时候跑出来？',
...
{ type: 'text', content: '孙中山小时候在私塾读书。那时候，先生只让学生背诵，不讲解意思。同学们都只是跟着背，谁也不敢问', animationType: 'reveal' },
        ...
        learningObjective: '我能理解课文《不懂就要问》的主要内容并体会作者情感',
        successCriteria: '①能概括课文主要内容 ②能体会作者表达的情感',
        iDo: '家长朗读课文，重点讲解孙中山小时候勤学好问的故事。',
        weDo: '亲子一起讨论：为什么不懂就要问？你有没有因为不敢问而后悔的经历？',
        youDo: '孩子独立阅读课文，写一段话谈谈自己对"不懂就要问"的理解。',
        parentTips: '【家长预习】诵(sòng)偏旁：讠本义：朗读引申义：背诵、诵读组词：…\n共学四步：\n①对话出题：问孩子"孙中山小时候做了什么让先生惊讶的事？"\n②孩子应答：孙中山主动向先生提问，这在当时是很少见的，因为学生一般不敢问先生。\n③答错引导：家长可以教孩子用"找关键词法"——回到课文找关键句子定位答案\n④快速检测：孙中山小时候做了什么让先生惊讶的事？、学问学问，不懂就要（    ）、这个故事告诉我们什么？',
      ...
      },
      {
        ...
        parentTips: '【家长预习】学完了"学校生活"这个单元，让我们把所有知识综合起来，看…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
...
{ type: 'poem', content: '山行\n【唐】杜牧\n\n远上寒山石径斜，\n白云生处有人家。\n停车坐爱枫林晚，\n霜叶红于二月花。', label: '古诗原文', animationType: 'reveal' },
        ...
        parentTips: '【家长预习】霜(shuāng)偏旁：雨本义：水汽凝结的白色晶体引申义…\n共学四步：\n①对话出题：问孩子"霜叶红于二月花"中"于"是什么意思？"\n②孩子应答："于"是"比"的意思，"红于二月花"就是比二月的花还红。\n③答错引导：家长可以和孩子一起看课文插图，用"画面记忆法"——把每句诗变成一幅画，看图背诗\n④快速检测："霜叶红于二月花"中"于"是什么意思？、远上寒山石径（    ）、这首诗描写的是哪个季节？',
...
{ type: 'poem', content: '赠刘景文\n【宋】苏轼\n\n荷尽已无擎雨盖，\n菊残犹有傲霜枝。\n一年好景君须记，\n最是橙黄橘绿时。', label: '古诗原文', animationType: 'reveal' },
        ...
        learningObjective: '我能背诵古诗《赠刘景文》并理解诗句的意思和表达的情感',
        successCriteria: '①能正确流利背诵《赠刘景文》全诗 ②能说出诗句的意思和诗人表达的情感',
        iDo: '家长朗读古诗，对比诗中"荷尽"和"菊残"与"橙黄橘绿"的不同景象。',
        weDo: '亲子一起讨论：苏轼为什么说"橙黄橘绿时"是最好的时节？',
        youDo: '孩子独立背诵古诗，说说诗中对比了哪些景象。',
        parentTips: '【家长预习】赠(zèng)偏旁：贝本义：送引申义：赠送、赠品组词：赠…\n共学四步：\n①对话出题：问孩子"荷尽已无擎雨盖"描写的是什么季节？"\n②孩子应答：荷花凋谢、菊花也快谢了，这是秋末冬初的景象。\n③答错引导：家长可以和孩子一起看课文插图，用"画面记忆法"——把每句诗变成一幅画，看图背诗\n④快速检测："荷尽已无擎雨盖"描写的是什么季节？、一年好景君须记，最是橙黄（    ）绿时、这首诗的作者是谁？',
...
{ type: 'poem', content: '夜书所见\n【宋】叶绍翁\n\n萧萧梧叶送寒声，\n江上秋风动客情。\n知有儿童挑促织，\n夜深篱落一灯明。', label: '古诗原文', animationType: 'reveal' },
        ...
        learningObjective: '我能背诵古诗《夜书所见》并理解诗句的意思和表达的情感',
        successCriteria: '①能正确流利背诵《夜书所见》全诗 ②能说出诗句的意思和诗人表达的情感',
        iDo: '家长朗读古诗，营造安静氛围，让孩子感受诗人的思乡之情。',
        weDo: '亲子一起讨论：诗人在秋夜看到了什么？想到了什么？心情怎样？',
        youDo: '孩子独立背诵古诗，用自己的话说说诗人的心情。',
        parentTips: '【家长预习】萧(xiāo)偏旁：艹本义：风声引申义：萧萧、萧条组词：…\n共学四步：\n①对话出题：问孩子"挑促织"中"促织"是什么？"\n②孩子应答："促织"是蟋蟀的别称，儿童在篱笆旁用灯光捉蟋蟀。\n③答错引导：家长可以和孩子一起看课文插图，用"画面记忆法"——把每句诗变成一幅画，看图背诗\n④快速检测："挑促织"中"促织"是什么？、萧萧梧叶送（    ）声、诗人看到儿童挑促织时心情怎样？',
      ...
      },
      {
        ...
        weDo: '亲子一起做综合练习，互相出题考对方。',
        youDo: '孩子独立完成综合练习，把本单元知识串联起来。',
        parentTips: '【家长预习】学完了"写景文章"这个单元，让我们把所有知识综合起来，看…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
        funElement: '小游戏：知识大串联！把本单元学到的知识连成一条线，看谁连得最长！🔗',
        gsapAnimations: ['GSAP: 综合复习动画'],
        images: ['IMG: 综合应用场景图'],
        practiceQuestions: [
...
{ type: 'text', content: '一棵树和一只鸟儿是好朋友。鸟儿站在树枝上，天天给树唱歌，树天天听着鸟儿唱', animationType: 'reveal' },
        ...
        learningObjective: '我能理解课文《去年的树》的主要内容并体会作者情感',
        successCriteria: '①能概括课文主要内容 ②能体会作者表达的情感',
        iDo: '家长朗读课文，用不同语气表现鸟儿寻找大树时的焦急和失望。',
        weDo: '亲子一起讨论：鸟儿为什么要对着灯火唱歌？它心里在想什么？',
        youDo: '孩子独立朗读课文，写出鸟儿三次问话的对象和回答。',
        parentTips: '【家长预习】柴(chái)偏旁：木本义：木柴引申义：柴火、柴门组词：…\n共学四步：\n①对话出题：问孩子"鸟儿对着灯火唱歌是因为什么？"\n②孩子应答：大树被砍伐做成了火柴，火柴点燃了灯火，鸟儿对着灯火唱歌是信守对大树的承诺。\n③答错引导：家长可以教孩子用"找关键词法"——回到课文找关键句子定位答案\n④快速检测：鸟儿对着灯火唱歌是因为什么？、鸟儿找大树时，先问了树根，又问了（    ），…、这个故事的主题是什么？',
...
{ type: 'text', content: '一粒种子被埋在泥土里，它想："我一定要站起来，那一定会很好！"', animationType: 'reveal' },
        ...
        learningObjective: '我能理解课文《那一定会很好》的主要内容并体会作者情感',
        successCriteria: '①能概括课文主要内容 ②能体会作者表达的情感',
        iDo: '家长朗读课文，画出种子从种子→大树→手推车→椅子→木地板的变化过程。',
        weDo: '亲子一起讨论：种子每次变化时说了什么？它为什么想变化？',
        youDo: '孩子独立画出种子的变化过程图，并写出每次变化的原因。',
        parentTips: '【家长预习】推(tuī)偏旁：扌本义：用力向前引申义：推动、推车组词…\n共学四步：\n①对话出题：问孩子"种子第一次变成了什么？"\n②孩子应答：种子先长成了一棵大树，因为它想"站起来看看世界"。\n③答错引导：家长可以教孩子用"找关键词法"——回到课文找关键句子定位答案\n④快速检测：种子第一次变成了什么？、大树被砍后做成了手推（    ）、按顺序排列种子的变化过程',
...
{ type: 'text', content: '两只蟋蟀——红头和青头在草地上玩捉迷藏。红头刚躲好，一头牛低头吃草，把红头和草一起卷到嘴里了！', animationType: 'reveal' },
        ...
        learningObjective: '我能理解课文《在牛肚子里旅行》的主要内容并体会作者情感',
        successCriteria: '①能概括课文主要内容 ②能体会作者表达的情感',
        iDo: '家长朗读课文，在牛的反刍过程处重点讲解科学知识。',
        weDo: '亲子一起画牛的消化系统简图，标注蟋蟀旅行的路线。',
        youDo: '孩子独立复述故事，说说蟋蟀是怎么从牛肚子里逃出来的。',
        parentTips: '【家长预习】胃(wèi)偏旁：月本义：消化器官引申义：胃口、胃肠组词…\n共学四步：\n①对话出题：问孩子"蟋蟀是怎么从牛肚子里出来的？"\n②孩子应答：牛会反刍，把胃里的草吐回嘴里重新咀嚼，蟋蟀就是趁反刍时和草一起回到嘴里逃出来的。\n③答错引导：家长可以教孩子用"找关键词法"——回到课文找关键句子定位答案\n④快速检测：蟋蟀是怎么从牛肚子里出来的？、牛有（    ）个胃、按顺序排列蟋蟀在牛肚子里的旅行路线',
      ...
      },
      {
        ...
        weDo: '亲子一起做综合练习，互相出题考对方。',
        youDo: '孩子独立完成综合练习，把本单元知识串联起来。',
        parentTips: '【家长预习】学完了"童话故事"这个单元，让我们把所有知识综合起来，看…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
        funElement: '小游戏：知识大串联！把本单元学到的知识连成一条线，看谁连得最长！🔗',
        gsapAnimations: ['GSAP: 综合复习动画'],
        images: ['IMG: 综合应用场景图'],
        practiceQuestions: [
...
{ type: 'text', content: '老屋已经一百多岁了，窗户变成了黑窟窿，门板也破了洞。它想倒下，可是总有人来请求帮助', animationType: 'reveal' },
        ...
        learningObjective: '我能理解课文《总也倒不了的老屋》的主要内容并体会作者情感',
        successCriteria: '①能概括课文主要内容 ②能体会作者表达的情感',
        iDo: '家长朗读课文，在每个小动物来请求帮助时暂停，让孩子预测老屋会不会倒。',
        weDo: '亲子一起讨论：你猜老屋会不会倒？为什么？看看预测对不对。',
        youDo: '孩子独立阅读课文，在每个转折处写下自己的预测。',
        parentTips: '【家长预习】预(yù)偏旁：页本义：预先引申义：预测、预防组词：预测…\n共学四步：\n①对话出题：问孩子"老屋为什么总也倒不了？"\n②孩子应答：每次老屋准备倒下时，都有小动物来请求帮助，老屋为了帮助它们一直坚持着。\n③答错引导：家长可以教孩子用"找关键词法"——回到课文找关键句子定位答案\n④快速检测：老屋为什么总也倒不了？、预测阅读就是在读故事时（    ）后面会发生什么、按顺序排列来请求帮助的小动物',
...
{ type: 'text', content: '预测阅读就是在读故事时猜一猜后面会发生什么。这是一种很好的阅读方法，能让我们读得更认真、更有趣', animationType: 'typewriter' },
        ...
        learningObjective: '我能根据课文内容进行合理预测',
        successCriteria: '①能根据线索做出合理预测 ②能说出预测的依据',
        iDo: '家长示范预测阅读的过程：看标题→猜内容→读课文→验证预测。',
        weDo: '亲子一起用预测阅读法读一篇新短文，边读边预测。',
        youDo: '孩子独立用预测阅读法阅读一篇短文，记录预测和结果。',
        parentTips: '【家长预习】洞(dòng)偏旁：氵本义：窟窿引申义：山洞、洞口组词：…\n共学四步：\n①对话出题：问孩子"预测阅读的第一步是什么？"\n②孩子应答：预测阅读第一步是看标题猜测内容，带着预测去阅读。\n③答错引导：家长可以和孩子一起重读相关段落，用"回到原文法"——在课文中找答案依据\n④快速检测：预测阅读的第一步是什么？、预测可以根据标题、插图和（    ）来猜测、预测错了怎么办？',
...
{ type: 'text', content: '阅读笔记就是边读边记录，把好词好句和自己的感受写下来。养成做笔记的习惯，阅读效果会更好！', animationType: 'typewriter' },
        ...
        learningObjective: '我能学会做阅读笔记，记录阅读收获',
        successCriteria: '①能记录主要内容 ②能写出自己的思考',
        iDo: '家长示范做阅读笔记：摘抄好词好句、写感受、画思维导图。',
        weDo: '亲子一起读一篇短文，合作完成阅读笔记。',
        youDo: '孩子独立完成一篇阅读笔记，包含摘抄、感受和思维导图。',
        parentTips: '【家长预习】胡(hú)偏旁：月本义：胡子引申义：胡萝卜、胡说组词：胡…\n共学四步：\n①对话出题：问孩子"阅读笔记应该包含什么？"\n②孩子应答：完整的阅读笔记应包含摘抄好词好句、写自己的感受和画思维导图。\n③答错引导：家长可以和孩子一起重读相关段落，用"回到原文法"——在课文中找答案依据\n④快速检测：阅读笔记应该包含什么？、做阅读笔记时，摘抄（    ）词（    ）句、按顺序排列做阅读笔记的步骤',
      ...
      },
      {
        ...
        weDo: '亲子一起做综合练习，互相出题考对方。',
        youDo: '孩子独立完成综合练习，把本单元知识串联起来。',
        parentTips: '【家长预习】学完了"阅读策略"这个单元，让我们把所有知识综合起来，看…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
        funElement: '小游戏：知识大串联！把本单元学到的知识连成一条线，看谁连得最长！🔗',
        gsapAnimations: ['GSAP: 综合复习动画'],
        images: ['IMG: 综合应用场景图'],
        practiceQuestions: [
...
{ type: 'text', content: '我们村子前面有一大片草地。早上，蒲公英的花瓣是合拢的，草地是绿色的；中午，蒲公英的花瓣张开了，草地变成金色的了！', animationType: 'reveal' },
        ...
        learningObjective: '我能理解课文《金色的草地》的主要内容并体会作者情感',
        successCriteria: '①能概括课文主要内容 ②能体会作者表达的情感',
        iDo: '家长朗读课文，重点讲解作者发现蒲公英变化的观察过程。',
        weDo: '亲子一起讨论：作者是怎么发现蒲公英的秘密的？你观察过什么有趣的现象？',
        youDo: '孩子独立朗读课文，写出作者观察蒲公英的发现过程。',
        parentTips: '【家长预习】翠(cuì)偏旁：羽本义：绿色引申义：翠绿、翠鸟组词：翠…\n共学四步：\n①对话出题：问孩子"蒲公英的花在什么时候合拢？"\n②孩子应答：蒲公英的花早上张开，晚上合拢，就像人白天活动晚上睡觉一样。\n③答错引导：家长可以教孩子用"找关键词法"——回到课文找关键句子定位答案\n④快速检测：蒲公英的花在什么时候合拢？、草地变成金色是因为蒲公英（    ）了、作者为什么能发现蒲公英的秘密？',
...
{ type: 'text', content: '天都峰又高又陡，"我"站在峰脚下想：这么高这么陡，我怎么爬得上去呢？', animationType: 'reveal' },
        ...
        learningObjective: '我能理解课文《爬天都峰》的主要内容并体会作者情感',
        successCriteria: '①能概括课文主要内容 ②能体会作者表达的情感',
        iDo: '家长朗读课文，重点分析"我"爬天都峰前后的心理变化。',
        weDo: '亲子一起讨论：你有没有遇到困难想放弃的时候？最后怎么克服的？',
        youDo: '孩子独立朗读课文，画出描写"我"心理变化的句子。',
        parentTips: '【家长预习】蒲(pú)偏旁：艹本义：蒲公英引申义：蒲公英、蒲草组词：…\n共学四步：\n①对话出题：问孩子"我"爬天都峰前的心情是什么？"\n②孩子应答："我"看到天都峰又高又陡，心里害怕想放弃。\n③答错引导：家长可以教孩子用"找关键词法"——回到课文找关键句子定位答案\n④快速检测："我"爬天都峰前的心情是什么？、老爷爷和"我"互相（    ），给了对方勇气、这个故事告诉我们什么？',
...
{ type: 'text', content: '观察日记就是把你持续观察某事物的变化过程记录下来。要写清时间、天气和观察对象的变化', animationType: 'typewriter' },
        ...
        learningObjective: '我能按顺序观察事物并用日记形式记录观察发现',
        successCriteria: '①能按顺序观察并记录至少3个发现 ②日记格式正确，语句通顺',
        iDo: '家长示范写观察日记：选择观察对象→持续观察→记录变化→写出感受。',
        weDo: '亲子一起选择一个观察对象（如豆芽生长），开始连续观察并记录。',
        youDo: '孩子独立写一篇观察日记，记录某事物的变化过程。',
        parentTips: '【家长预习】察(chá)偏旁：宀本义：仔细看引申义：观察、察觉组词：…\n共学四步：\n①对话出题：问孩子"观察日记最重要的是什么？"\n②孩子应答：观察日记最重要的是持续观察并记录事物的变化过程。\n③答错引导：家长可以让孩子先列提纲再写，用"提纲引导法"——先写几个关键词，再扩展成句\n④快速检测：观察日记最重要的是什么？、观察日记要写清时间、天气和（    ）的变化、按顺序排列写观察日记的步骤',
      ...
      },
      {
        ...
        weDo: '亲子一起做综合练习，互相出题考对方。',
        youDo: '孩子独立完成综合练习，把本单元知识串联起来。',
        parentTips: '【家长预习】学完了"观察日记"这个单元，让我们把所有知识综合起来，看…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
        funElement: '小游戏：知识大串联！把本单元学到的知识连成一条线，看谁连得最长！🔗',
        gsapAnimations: ['GSAP: 综合复习动画'],
        images: ['IMG: 综合应用场景图'],
        practiceQuestions: [
...
{ type: 'text', content: '写景作文就是描写一个美丽的地方。要用"总分总"结构，还要用多种感官来描写', animationType: 'typewriter' },
        ...
        learningObjective: '我能按顺序写一次经历或一处美景，表达真实感受',
        successCriteria: '①按顺序写清经过或景色 ②表达出真实的感受',
        iDo: '家长示范写一段景物描写，展示如何用"总分总"结构和感官描写。',
        weDo: '亲子一起选择一个美丽的地方，一人说一段描写，合作完成作文。',
        youDo: '孩子独立写一篇"这儿真美"的作文，用上感官描写。',
        parentTips: '【家长预习】景(jǐng)偏旁：日本义：日光引申义：风景、景色组词：…\n共学四步：\n①对话出题：问孩子"写景作文最好用什么结构？"\n②孩子应答：写景作文用"总分总"结构最清晰：先总写美景，再分写不同方面，最后总结感受。\n③答错引导：家长可以让孩子先列提纲再写，用"提纲引导法"——先写几个关键词，再扩展成句\n④快速检测：写景作文最好用什么结构？、写景时可以用看、听、闻、触和（    ）五种感官、把感官和描写内容配对',
...
{ type: 'text', content: '"我有一个想法"就是写你对生活中某个问题的观察和建议。先说现象，再说想法，最后提建议', animationType: 'typewriter' },
        ...
        learningObjective: '我能写一段话表达自己的想法，做到理由清楚',
        successCriteria: '①想法清楚，有至少1个理由 ②语句通顺',
        iDo: '家长示范写"我有一个想法"，展示如何提出问题、分析原因、给出建议。',
        weDo: '亲子一起讨论生活中的问题，选择一个共同关注的话题。',
        youDo: '孩子独立写一篇"我有一个想法"的作文，提出自己的建议。',
        parentTips: '【家长预习】想(xiǎng)偏旁：心本义：思考引申义：想法、想象组词…\n共学四步：\n①对话出题：问孩子"我有一个想法"作文应该先写什么？"\n②孩子应答：写作文应该先说生活中的现象或问题，让读者知道你在关注什么。\n③答错引导：家长可以让孩子先列提纲再写，用"提纲引导法"——先写几个关键词，再扩展成句\n④快速检测："我有一个想法"作文应该先写什么？、写作文时要先说现象，再说想法，最后提（    ）、下面哪个是好的"想法"？',
...
{ type: 'text', content: '叙事作文就是写一件事情。要写清六要素：时间、地点、人物、起因、经过、结果', animationType: 'typewriter' },
        ...
        parentTips: '【家长预习】修(xiū)偏旁：亻本义：修理引申义：修改、修理组词：修…\n共学四步：\n①对话出题：问孩子"叙事作文要写清几个要素？"\n②孩子应答：叙事作文要写清六要素：时间、地点、人物、起因、经过、结果。\n③答错引导：家长可以让孩子先列提纲再写，用"提纲引导法"——先写几个关键词，再扩展成句\n④快速检测：叙事作文要写清几个要素？、叙事作文要按（    ）顺序来写、把叙事六要素按顺序排列',
      ...
      },
      {
        ...
        weDo: '亲子一起做综合练习，互相出题考对方。',
        youDo: '孩子独立完成综合练习，把本单元知识串联起来。',
        parentTips: '【家长预习】学完了"习作训练"这个单元，让我们把所有知识综合起来，看…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
        funElement: '小游戏：知识大串联！把本单元学到的知识连成一条线，看谁连得最长！🔗',
        gsapAnimations: ['GSAP: 综合复习动画'],
        images: ['IMG: 综合应用场景图'],
        practiceQuestions: [
...
{ type: 'poem', content: '司马光\n\n群儿戏于庭，一儿登瓮，足跌没水中。\n众皆弃去，光持石击瓮破之，\n水迸，儿得活。', label: '文言文原文', animationType: 'reveal' },
        ...
        parentTips: '【家长预习】守(shǒu)偏旁：宀本义：看守引申义：守护、守卫组词：…\n共学四步：\n①对话出题：问孩子"群儿戏于庭"中"于"是什么意思？"\n②孩子应答："于"在这里是"在"的意思，"戏于庭"就是在院子里玩耍。\n③答错引导：家长可以和孩子一起逐字对照注释，用"字字对译法"——一个字一个字地看注释，连起来理解句意\n④快速检测："群儿戏于庭"中"于"是什么意思？、司马光用（    ）砸破了水缸、其他小孩看到有人落水后做了什么？',
...
{ type: 'poem', content: '守株待兔\n\n宋人有耕者。田中有株。\n兔走触株，折颈而死。\n因释其耒而守株，冀复得兔。\n兔不可复得，而身为宋国笑。', label: '文言文原文', animationType: 'reveal' },
        ...
        parentTips: '【家长预习】司(sī)偏旁：口本义：管理引申义：司马、公司组词：司马…\n共学四步：\n①对话出题：问孩子"因释其耒而守株"中"释"是什么意思？"\n②孩子应答："释"是放下的意思，宋人放下了农具去守树桩。\n③答错引导：家长可以和孩子一起逐字对照注释，用"字字对译法"——一个字一个字地看注释，连起来理解句意\n④快速检测："因释其耒而守株"中"释"是什么意思？、宋人因为一只兔子撞死在树桩上，就放下了（   …、这个故事讽刺了什么？',
...
{ type: 'text', content: '文言文是古人写的文章，和现代文有很多不同。学会阅读文言文，就能读懂古人的智慧！', animationType: 'typewriter' },
        ...
        parentTips: '【家长预习】文(wén)偏旁：文本义：文字引申义：文言、文化组词：文…\n共学四步：\n①对话出题：问孩子"读文言文第一步应该做什么？"\n②孩子应答：读文言文第一步是借助注释读原文，初步理解大意。\n③答错引导：家长可以和孩子一起逐字对照注释，用"字字对译法"——一个字一个字地看注释，连起来理解句意\n④快速检测：读文言文第一步应该做什么？、文言文阅读四步法：借助注释、对照翻译、反复（ …、按正确顺序排列文言文阅读步骤',
      ...
      },
      {
        ...
        weDo: '亲子一起做综合练习，互相出题考对方。',
        youDo: '孩子独立完成综合练习，把本单元知识串联起来。',
        parentTips: '【家长预习】学完了"文言文启蒙"这个单元，让我们把所有知识综合起来，…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
        funElement: '小游戏：知识大串联！把本单元学到的知识连成一条线，看谁连得最长！🔗',
        gsapAnimations: ['GSAP: 综合复习动画'],
        images: ['IMG: 综合应用场景图'],
        practiceQuestions: [
...
{ type: 'text', content: '复习字词要分类整理，逐个攻克！易错字、多音字、形近字、同音字，每种都有攻克的方法', animationType: 'typewriter' },
        ...
        parentTips: '【家长预习】阅(yuè)偏旁：门本义：看引申义：阅读、阅览组词：阅读…\n共学四步：\n①对话出题：问孩子"安静"的"静"和哪个字容易混淆？"\n②孩子应答："静"和"净"容易混淆，"安静"是静，"干净"是净。\n③答错引导：家长可以举例引导，用"举例法"——举一个生活中的例子帮助孩子理解\n④快速检测："安静"的"静"和哪个字容易混淆？、"假"是多音字，在"放假"中读（    ）、把形近字和正确的词配对',
...
{ type: 'text', content: '做阅读理解题有方法！先读文章了解大意，再看题目，然后回文找答案，最后组织语言回答', animationType: 'typewriter' },
        ...
        learningObjective: '我能运用阅读策略理解课文内容并回答问题',
        successCriteria: '①能运用本课方法理解课文 ②能正确回答相关问题',
        iDo: '家长示范做阅读理解题：先读文章→再看题目→回文找答案→组织语言。',
        weDo: '亲子一起做一篇阅读理解，讨论答题技巧。',
        youDo: '孩子独立完成一篇阅读理解练习，注意答题规范。',
        parentTips: '【家长预习】复(fù)偏旁：夂本义：重复引申义：复习、复习组词：复习…\n共学四步：\n①对话出题：问孩子"做阅读理解题第一步是什么？"\n②孩子应答：做阅读理解第一步是先读文章，了解大意后再看题目。\n③答错引导：家长可以和孩子一起重读相关段落，用"回到原文法"——在课文中找答案依据\n④快速检测：做阅读理解题第一步是什么？、阅读理解的答案要在（    ）中找依据、回答阅读理解题时应该怎样？',
...
{ type: 'text', content: '好作文是改出来的！修改作文能让文章从普通变得优秀。修改时要关注内容、语言和结构', animationType: 'typewriter' },
        ...
        learningObjective: '我能完成本课写作任务，写出一篇内容充实的文章',
        successCriteria: '①文章结构完整，内容充实 ②语言通顺，无明显错误',
        iDo: '家长展示一篇作文的修改过程：从草稿到修改稿，标注修改原因。',
        weDo: '亲子一起修改孩子的一篇旧作文，讨论哪里可以写得更好。',
        youDo: '孩子独立修改一篇旧作文，至少做三处改进。',
        parentTips: '【家长预习】考(kǎo)偏旁：老本义：测试引申义：考试、考核组词：考…\n共学四步：\n①对话出题：问孩子"修改作文时首先要关注什么？"\n②孩子应答：修改作文首先要关注内容是否具体，空洞的内容再华丽的语言也没用。\n③答错引导：家长可以让孩子先列提纲再写，用"提纲引导法"——先写几个关键词，再扩展成句\n④快速检测：修改作文时首先要关注什么？、好作文是（    ）出来的、按顺序排列修改作文的步骤',
      ...
      },
      {
        ...
        weDo: '亲子一起做综合练习，互相出题考对方。',
        youDo: '孩子独立完成综合练习，把本单元知识串联起来。',
        parentTips: '【家长预习】学完了"综合复习"这个单元，让我们把所有知识综合起来，看…\n共学四步：\n①对话出题：测试前问孩子"这个单元你觉得最难的是什么？最容易的是什么？"\n②孩子应答：孩子说出自己觉得最难和最容易的部分\n③答错引导：把错题分类，针对薄弱点用实物或画图重新讲解\n④快速检测：让孩子挑3道错题重新做，说说现在为什么这样选',
        funElement: '小游戏：知识大串联！把本单元学到的知识连成一条线，看谁连得最长！🔗',
        gsapAnimations: ['GSAP: 综合复习动画'],
        images: ['IMG: 综合应用场景图'],
        practiceQuestions: [
