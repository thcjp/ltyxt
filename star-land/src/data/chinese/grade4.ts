    ...
    lessons: [
      {
        ...
        parentTips: '用对比法让孩子理解近义词的细微差别，多举生活中的例子帮助理解。',
      ...
      },
      {
        ...
        parentTips: '用词语消消乐游戏让孩子在玩中学，配对反义词更有趣味。',
      ...
      },
      {
        ...
        parentTips: '引导孩子先找词语的共同特点，再确定类别名称，培养分类归纳能力。',
      ...
      },
      {
        ...
        parentTips: '让孩子多读多念这些词语，感受重叠词的节奏感和生动性。',
      ...
      },
      {
        ...
        parentTips: '鼓励孩子综合运用所学词语方法，正确率达标即可获得"词语小达人"称号。',
    ...
    lessons: [
      {
        ...
        parentTips: '用故事引出成语，让孩子感受成语的画面感，比死记硬背效果好得多。',
      ...
      },
      {
        ...
        parentTips: '用动物故事引出成语，按动物分类学成语，孩子更容易记住。',
      ...
      },
      {
        ...
        parentTips: '让孩子演一演寓言故事，加深对道理的理解，比单纯讲解更有效。',
      ...
      },
      {
        ...
        parentTips: '历史成语故事较长，可以分段讲，重点让孩子理解成语的道理。',
      ...
      },
      {
        ...
        parentTips: '鼓励孩子用成语写话，正确率达标即可获得"成语小达人"称号。',
    ...
    lessons: [
      {
        ...
        parentTips: '段意概括三步法：读全段→找中心句→用自己的话说，引导孩子逐步掌握。',
      ...
      },
      {
        ...
        parentTips: '要素串联法：时间+地点+人物+起因+经过+结果，引导孩子按顺序找要素。',
      ...
      },
      {
        ...
        parentTips: '用红笔标喜悦、蓝笔标悲伤，让孩子用颜色直观感受情感的变化。',
      ...
      },
      {
        ...
        parentTips: '从"做什么"和"说什么"推断"是什么样的人"，引导孩子有理有据地分析。',
      ...
      },
      {
        ...
        parentTips: '2篇短文阅读理解，正确率达标即可获得"阅读小达人"称号。引导孩子用三遍阅读法。',
    ...
    lessons: [
      {
        ...
        parentTips: '六块积木搭框架，先说后写。让孩子先口头说框架，再写下来。',
      ...
      },
      {
        ...
        parentTips: '经过展开三问法：先做什么？然后做什么？最后做什么？引导孩子一步步写。',
      ...
      },
      {
        ...
        youDo: '孩子独立分解动作写一段话。',
        parentTips: '动作分解法：把一个动作拆成3-5个小动作，用准确动词和修饰词。',
      ...
      },
      {
        ...
        parentTips: '对话剧场：家长和孩子分角色演，然后写下来。演一演更有感觉！',
      ...
      },
      {
        ...
        parentTips: '独立写一篇300字写事记叙文，包含六要素、经过详写、动作和对话描写。',
    ...
    lessons: [
      {
        ...
        parentTips: '从实物出发，用感官观察法列出特征。让孩子先观察再写。',
      ...
      },
      {
        ...
        youDo: '孩子独立用说明方法写一段话。',
        parentTips: '列数字要准确，作比较要选熟悉的参照物。引导孩子两种方法配合使用。',
      ...
      },
      {
        ...
        youDo: '孩子独立用说明方法写一段话。',
        parentTips: '打比方用比喻说明特点，举例子用具体例子说明。引导孩子灵活运用。',
      ...
      },
      {
        ...
        parentTips: '总分总：先总述→再分述特点→最后总结。引导孩子搭好结构再填内容。',
      ...
      },
      {
        ...
        parentTips: '独立写200字说明文，至少用2种说明方法，总分总结构。正确率达标获"说明文小达人"称号。',
    ...
    lessons: [
      {
        ...
        youDo: '孩子独立画画面并背诵诗歌。',
        parentTips: '边读诗边画图，把文字变成画面。让孩子感受瀑布的壮观。',
      ...
      },
      {
        ...
        parentTips: '找诗中的情感词"爱"，体会诗人对秋天枫林的喜爱之情。',
      ...
      },
      {
        ...
        youDo: '孩子独立背诵一首含月诗。',
        parentTips: '月亮在古诗中常表示思乡之情。引导孩子理解意象的含义。',
      ...
      },
      {
        ...
        youDo: '孩子独立对比两首诗的异同。',
        parentTips: '对比同一主题的不同写法，引导孩子从作者、主题、写法、情感等方面比较。',
      ...
      },
      {
        ...
        parentTips: '背诵2首+理解题正确率达标即可获得"古诗达人"称号。',
    ...
    lessons: [
      {
        ...
        youDo: '孩子独立朗读诗歌并标注节奏。',
        parentTips: '用拍手打节拍帮助感受诗歌节奏。和孩子一起朗读，读出感情。',
      ...
      },
      {
        ...
        youDo: '孩子独立找意象并描述画面。',
        parentTips: '读诗时想象意象画面，如大海、星星、花朵。引导孩子描述脑海中的画面。',
      ...
      },
      {
        ...
        youDo: '孩子独立仿写一首短诗。',
        parentTips: '仿写要保留原诗格式和句式，换新意象。引导孩子大胆创作。',
      ...
      },
      {
        ...
        youDo: '孩子独立创作一首短诗。',
        parentTips: '从灵感到成诗：看到什么→想到什么→选意象→写下来。鼓励孩子大胆创作。',
      ...
      },
      {
        ...
        parentTips: '举办家庭朗诵会，录音展示。从站姿、声音、感情等方面评价。',
    ...
    lessons: [
      {
        ...
        parentTips: '选题三问法：感兴趣吗？有资料吗？范围合适吗？引导孩子选可行的研究主题。',
      ...
      },
      {
        ...
        parentTips: '引导孩子从多渠道收集资料，用表格分类整理，记录资料来源。',
      ...
      },
      {
        ...
        parentTips: '研究报告六部分：题目、目的、方法、过程、结果、结论。引导孩子完整填写。',
      ...
      },
      {
        ...
        parentTips: '用查漏补缺法复习词语和阅读理解。做几道题发现薄弱点再重点复习。',
      ...
      },
      {
        ...
        parentTips: '完成综合测评，正确率达标即可获得"语文小达人"称号。鼓励孩子自信应考。',
