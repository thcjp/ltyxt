    ...
    lessons: [
      {
        ...
        parentTips: '发音时注意嘴型要到位，可以让孩子用手感受气流的变化。',
      ...
      },
      {
        ...
        parentTips: 'b和p容易混淆，重点区分：b的半圆在右下，p的半圆在右上。',
      ...
      },
      {
        ...
        parentTips: 'j q x和ü相拼时要去掉两点，可以用"j q x真淘气，见到ü眼就挖去"来记忆。',
      ...
      },
      {
        ...
        parentTips: '拼音学习的最终目的是应用，鼓励孩子在生活中使用拼音。',
    ...
    lessons: [
      {
        ...
        parentTips: '南方孩子容易混淆平翘舌音，可以让孩子用手指感受舌头位置来辅助记忆。',
      ...
      },
      {
        ...
        parentTips: '复韵母标调有规则：有a不放过，没a找o e，i u并列标在后。',
      ...
      },
      {
        ...
        parentTips: '前鼻音n舌尖抵上齿龈，后鼻音ng舌根抵软腭，让孩子感受发音位置的不同。',
      ...
      },
      {
        ...
        parentTips: '整体认读音节容易和拼读音节混淆，要特别强调"不用拼，直接读"。',
      ...
      },
      {
        ...
        parentTips: '鼓励孩子在生活中使用拼音，比如用拼音写购物清单。',
...
{ type: 'text', content: '"天"——头顶上广阔的天空。上面一横代表天空，下面是"大"，人头顶上的就是天', animationType: 'reveal' },
        ...
        parentTips: '识字要和生活联系，让孩子在真实场景中理解字义。',
...
{ type: 'text', content: '"金"——闪闪发光的金属。金色的阳光、金色的奖牌，金是很贵重的东西', animationType: 'reveal' },
        ...
        parentTips: '可以用"一二三四五，金木水火土"口诀帮助记忆顺序。',
...
{ type: 'poem', content: '对韵歌\n\n云对雨，雪对风。\n花对树，鸟对虫。\n山清对水秀，\n柳绿对桃红。', label: '对韵歌原文', animationType: 'reveal' },
        ...
        parentTips: '对韵歌的重点是感受语言的韵律和对称美，不必强求理解每个字。',
...
{ type: 'text', content: '秋天来了！天气凉了，树叶黄了，一片片叶子从树上落下来', animationType: 'reveal' },
        ...
        parentTips: '秋天是带孩子户外观察的好时机，读完课文可以去公园感受秋天。',
...
{ type: 'poem', content: '小小的船\n\n弯弯的月儿小小的船，\n小小的船儿两头尖，\n我在小小的船里坐，\n只看见闪闪的星星蓝蓝的天。', label: '课文原文', animationType: 'reveal' },
        ...
        parentTips: '鼓励孩子大胆想象，不要限制他们的创意表达。',
...
{ type: 'poem', content: '江南\n汉乐府\n\n江南可采莲，\n莲叶何田田。\n鱼戏莲叶间，\n鱼戏莲叶东，\n鱼戏莲叶西，\n鱼戏莲叶南，\n鱼戏莲叶北。', label: '古诗原文', animationType: 'reveal' },
        ...
        parentTips: '古诗学习重在诵读感受，不必逐字翻译，让孩子体会意境即可。',
...
{ type: 'poem', content: '雪地里的小画家\n\n下雪啦，下雪啦！\n雪地里来了一群小画家。\n小鸡画竹叶，小狗画梅花，\n小鸭画枫叶，小马画月牙。\n不用颜料不用笔，\n几步就成一幅画。\n青蛙为什么没参加？\n他在洞里睡着啦。', label: '课文原文', animationType: 'reveal' },
        ...
        parentTips: '下雪时可以带孩子去雪地踩脚印，对比课文中的描述。',
...
{ type: 'text', content: '一只乌鸦口渴了，到处找水喝。可是瓶子里水不多，瓶口又小，乌鸦喝不着水，怎么办呢？', animationType: 'reveal' },
        ...
        parentTips: '通过实验让孩子理解"遇到困难要想办法"的道理，培养解决问题的思维。',
...
{ type: 'text', content: '小蜗牛爬得太慢了！每次妈妈让它去看风景，等它爬到的时候，季节已经变了', animationType: 'reveal' },
        ...
        parentTips: '引导孩子理解"慢"的含义——蜗牛太慢了，所以总是错过当季的风景。',
    ...
    lessons: [
      {
        ...
        parentTips: '反义词学习可以帮助孩子理解词义，同时锻炼思维能力。',
      ...
      },
      {
        ...
        parentTips: '量词是汉语特有的，需要多读多练才能自然掌握。',
      ...
      },
      {
        ...
        parentTips: '鼓励孩子用多种感官去感受事物，用更丰富的词语来表达。',
    ...
    lessons: [
      {
        ...
        parentTips: '古诗学习先感受画面，再理解意思，最后背诵，循序渐进。',
      ...
      },
      {
        ...
        parentTips: '结合日常生活教育孩子珍惜粮食，不要只停留在背诵层面。',
      ...
      },
      {
        ...
        parentTips: '让孩子理解"思乡"的情感，可以联系离开爷爷奶奶时的想念。',
