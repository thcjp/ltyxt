    ...
    lessons: [
      {
        ...
        title: '厘米的认识',
        order: 1,
        teachingMethod: 'CPA实物测量→图示刻度→符号记录',
        iDo: '家长用直尺示范测量铅笔的长度，对准0刻度线读数。',
        weDo: '亲子一起用直尺测量身边的物品，读出厘米数。',
        youDo: '孩子独立用直尺测量物品并记录长度。',
        parentTips: '测量时一定要从0刻度线开始，眼睛平视读数。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '0刻度',
            hint: '从哪里开始量最准确？',
            explanation: '测量时要把直尺的0刻度线对齐物体的一端，这样读数才准确。'
          },
          {
            id: 'm2u1l1q2',
            type: 'fill',
            ...
            hint: '用直尺量一量你的食指宽度',
            explanation: '食指的宽度大约是1厘米，这是1厘米的直观感受。'
          },
          {
            id: 'm2u1l1q3',
            type: 'flashcard',
      ...
      },
      {
        ...
        title: '米的认识',
        order: 2,
        teachingMethod: 'I Do→We Do→You Do，身体参照法',
        iDo: '家长用米尺展示1米的长度，和孩子的身高做比较。',
        weDo: '亲子一起用米尺量教室或房间的长度，感受1米有多长。',
        youDo: '孩子独立估测和测量物品的长度，选择合适的单位。',
        parentTips: '1米=100厘米，量较长的物体用米，较短的用厘米。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '100厘米',
            hint: '米和厘米的换算关系',
            explanation: '1米=100厘米，这是长度单位的基本换算。'
          },
          {
            id: 'm2u1l2q2',
            type: 'fill',
            ...
            answer: '200',
            hint: '1米=100厘米，2米呢？',
            explanation: '1米=100厘米，2米=2×100=200厘米。'
          },
          {
            id: 'm2u1l2q3',
            type: 'flashcard',
            ...
            answer: '米',
            hint: '操场很长，用大单位还是小单位？',
            explanation: '操场很长，用米作单位更合适，厘米太小了。'
          }
        ,
          {
            id: 'm2u1l2q4',
      ...
      },
      {
        ...
        title: '测量小能手',
        order: 3,
        teachingMethod: '情境化实践，估测与实测结合',
        iDo: '家长示范先估测再测量的方法，比较估测和实测的差距。',
        weDo: '亲子一起估测家中物品的长度，再用尺子实测验证。',
        youDo: '孩子独立估测和测量物品长度，记录结果。',
        parentTips: '先估后量是好习惯，培养孩子的长度直觉。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '70厘米',
            hint: '课桌到你腰的位置',
            explanation: '课桌高度大约70厘米，7厘米太矮，7米太高。'
          },
          {
            id: 'm2u1l3q2',
            type: 'fill',
        ...
        ,
          ...
          },
          {
            ...
            explanation: '9+8=17，用凑十法：9+1=10，10+7=17。'
          }
        ]
      }
    ,
          ...
          practiceQuestions: [
            {
              ...
              answer: '90厘米',
              hint: '100-30+20=？',
              explanation: '100-30=70，70+20=90厘米。'
            },
            {
            id: 'm2u1l5q2',
            type: 'fill',
    ...
    lessons: [
      {
        ...
        title: '不进位加法',
        order: 1,
        teachingMethod: 'CPA小棒操作→竖式图示→符号计算',
        iDo: '家长用竖式演示23+14：个位3+4=7，十位2+1=3，结果是37。',
        weDo: '亲子一起用竖式做不进位加法，互相检查对位。',
        youDo: '孩子独立列竖式计算100以内不进位加法。',
        parentTips: '竖式计算关键是相同数位对齐，从个位加起。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '47',
            hint: '个位2+5，十位3+1',
            explanation: '个位2+5=7，十位3+1=4，所以32+15=47。'
          },
          {
            id: 'm2u2l1q2',
            type: 'fill',
            ...
            answer: '64',
            hint: '个位1+3，十位4+2',
            explanation: '个位1+3=4，十位4+2=6，所以41+23=64。'
          },
          {
            id: 'm2u2l1q3',
            type: 'flashcard',
            ...
            answer: '57',
            hint: '个位4+3，十位2+3',
            explanation: '个位4+3=7，十位2+3=5，所以24+33=57。'
          }
        ,
          {
            id: 'm2u2l1q4',
            ...
            answer: '个位5+3=8',
            hint: '竖式加法从个位算起',
            explanation: '竖式加法先从个位算起，个位5+3=8，再算十位4+3=7，得78。'
          },
          {
            id: 'm2u2l1q5',
            type: 'fill',
            ...
            explanation: '个位6+2=8，十位3+4=7，36+42=78。'
          },
          {
            id: 'm2u2l1q6',
            type: 'choice',
            ...
            explanation: '25+15=40，40+30=70最快！'
          },
          {
            id: 'm2u2l1q7',
            type: 'fill',
            ...
            explanation: '8+7=15，用凑十法：8+2=10，10+5=15。'
          }
        ]
      },
      {
        ...
        title: '进位加法',
        order: 2,
        teachingMethod: 'I Do→We Do→You Do，竖式进位法',
        iDo: '家长用竖式演示28+35：个位8+5=13，写3进1，十位2+3+1=6。',
        weDo: '亲子一起练习竖式进位加法，重点练习"满十进一"。',
        youDo: '孩子独立列竖式计算100以内进位加法。',
        parentTips: '进位加法的关键是"满十进一"，别忘了加进上来的1。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '83',
            hint: '个位6+7满十了吗？',
            explanation: '个位6+7=13，写3进1；十位3+4+1=8，所以36+47=83。'
          },
          {
            id: 'm2u2l2q2',
            type: 'fill',
            ...
            answer: '87',
            hint: '个位8+9满十进一',
            explanation: '个位8+9=17，写7进1；十位5+2+1=8，所以58+29=87。'
          },
          {
            id: 'm2u2l2q3',
            type: 'flashcard',
            ...
            answer: '83',
            hint: '个位5+8=13，进1',
            explanation: '个位5+8=13，写3进1；十位4+3+1=8，所以45+38=83。'
          }
        ,
          {
            id: 'm2u2l2q4',
          ...
          },
          {
            ...
            explanation: '个位6+7=13写3进1，十位4+3+1=8，46+37=83。'
          },
          {
            id: 'm2u2l2q6',
            type: 'choice',
            ...
            answer: '90人',
            hint: '38+25+27=？',
            explanation: '38+25=63，63+27=90人。'
          },
          {
            id: 'm2u2l2q7',
            type: 'choice',
      ...
      },
      {
        ...
        title: '连加',
        order: 3,
        teachingMethod: 'CPA分步操作→图示连加→符号计算',
        iDo: '家长演示连加：23+14+32，先算23+14=37，再算37+32=69。',
        weDo: '亲子一起做连加练习，分步计算再合并。',
        youDo: '孩子独立计算连加算式。',
        parentTips: '连加可以分步计算，先算前两个数，再加第三个数。',
        ...
        ,
          ...
          },
          {
            ...
            explanation: '把6拆成1和5，9+1=10，10+5=15，所以9+6=15。'
          }
        ]
      }
    ,
          ...
          practiceQuestions: [
            {
              ...
              answer: '个位6+3=9',
              hint: '竖式加法从个位加起',
              explanation: '从个位加起：6+3=9，5+2=7，得79。'
            },
            {
            id: 'm2u2l4q2',
            type: 'fill',
            ...
            answer: '83',
            hint: '注意进位',
            explanation: '5+8=13写3进1，4+3+1=8，得83。'
          },
            {
              id: 'm2u2l4q5',
              type: 'choice',
          ...
          practiceQuestions: [
            {
              ...
              answer: '88人',
              hint: '先算女生再算总数',
              explanation: '女生35+18=53人，35+53=88人。'
            },
            {
            id: 'm2u2l5q2',
            type: 'fill',
          ...
          },
            {
              ...
              answer: '50本',
              hint: '25+38-13=？',
              explanation: '25+38=63，63-13=50本。'
            },
            {
            id: 'm2u2l5q4',
            type: 'fill',
          ...
          },
            {
              ...
              answer: '122本',
              hint: '先算连环画再算总数',
              explanation: '连环画56-18=38本，56+28+38=122本。'
            },
            {
              id: 'm2u2l5q6',
              type: 'choice',
            ...
            explanation: '7+5=12写2进1，6+2+1=9，得92。'
          },
          ]
        }
      ]
    ...
    lessons: [
      {
        ...
        order: 1,
        teachingMethod: 'CPA小棒操作→竖式图示→符号计算',
        iDo: '家长用竖式演示58-23：个位8-3=5，十位5-2=3，结果是35。',
        weDo: '亲子一起用竖式做不退位减法，互相检查。',
        youDo: '孩子独立列竖式计算100以内不退位减法。',
        parentTips: '减法竖式也是相同数位对齐，从个位减起。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '33',
            hint: '个位7-4，十位6-3',
            explanation: '个位7-4=3，十位6-3=3，所以67-34=33。'
          },
          {
            id: 'm2u3l1q2',
            type: 'fill',
            ...
            answer: '37',
            hint: '个位9-2，十位8-5',
            explanation: '个位9-2=7，十位8-5=3，所以89-52=37。'
          },
          {
            id: 'm2u3l1q3',
            type: 'flashcard',
            ...
            answer: '35',
            hint: '个位6-1，十位7-4',
            explanation: '个位6-1=5，十位7-4=3，所以76-41=35。'
          }
        ,
          {
            id: 'm2u3l1q4',
            ...
            answer: '5',
            hint: '竖式减法',
            explanation: '十位8-3=5，个位6-2=4，得54。'
          },
          {
            id: 'm2u3l1q5',
            type: 'fill',
            ...
            explanation: '个位9-4=5，十位7-4=3，79-45=34。'
          },
          {
            id: 'm2u3l1q6',
            type: 'choice',
          ...
          },
          {
            ...
            explanation: '13-6=7，用破十法：10-6=4，4+3=7。'
          }
        ]
      },
      {
        ...
        title: '退位减法',
        order: 2,
        teachingMethod: 'I Do→We Do→You Do，竖式退位法',
        iDo: '家长用竖式演示52-28：个位2-8不够减，借1当10，12-8=4，十位4-2=2。',
        weDo: '亲子一起练习退位减法，重点练习"不够减就借位"。',
        youDo: '孩子独立列竖式计算100以内退位减法。',
        parentTips: '退位减法的关键是个位不够减时向十位借1当10。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '36',
            hint: '个位3-7不够减，借1当10',
            explanation: '个位13-7=6，十位5-2=3，所以63-27=36。'
          },
          {
            id: 'm2u3l2q2',
            type: 'fill',
            ...
            answer: '36',
            hint: '个位1-5不够减，借位',
            explanation: '个位11-5=6，十位7-4=3，所以81-45=36。'
          },
          {
            id: 'm2u3l2q3',
            type: 'flashcard',
            ...
            answer: '35',
            hint: '个位4-9不够减',
            explanation: '个位14-9=5，十位4-1=3，所以54-19=35。'
          }
        ,
          {
            id: 'm2u3l2q4',
          ...
          },
          {
            ...
            explanation: '70-26：个位0-6不够减，借位10-6=4，十位7变6减2=4，得44。'
          },
          {
            id: 'm2u3l2q6',
            type: 'choice',
            ...
            answer: '69人',
            hint: '62-18+25=？',
            explanation: '62-18=44，44+25=69人。'
          },
          {
            id: 'm2u3l2q7',
            type: 'choice',
      ...
      },
      {
        ...
        title: '加减混合',
        order: 3,
        teachingMethod: '情境化练习，应用题驱动',
        iDo: '家长出应用题：有45个苹果，吃了18个，又买了12个，现在有几个？',
        weDo: '亲子一起做加减混合运算，理清先加后减还是先减后加。',
        youDo: '孩子独立计算加减混合算式。',
        parentTips: '加减混合要按从左到右的顺序计算，注意看清加号和减号。',
        ...
        ,
          ...
          },
          {
            ...
            answer: '20瓶',
            hint: '85-28-37=？',
            explanation: '85-28=57，57-37=20瓶。'
          },
          {
            id: 'm2u3l3q7',
            type: 'fill',
            ...
            explanation: '个位8+5=13写3进1，十位4+3+1=8，48+35=83。'
          }
        ]
      }
    ,
        {
          ...
          practiceQuestions: [
          ...
          },
            {
              ...
              answer: '从十位借1当10',
              hint: '借位减法',
              explanation: '从十位借1，13-8=5，十位4-2=2，得25。'
            },
            {
            id: 'm2u3l4q4',
            type: 'fill',
          ...
          },
            {
              ...
              answer: '21个',
              hint: '85-36-28=？',
              explanation: '85-36=49，49-28=21个。'
            },
            {
              id: 'm2u3l4q6',
              type: 'choice',
              ...
              answer: '53',
              hint: '借位减法',
              explanation: '10-7=3借位，9-4=5，得53。'
            },
            {
            id: 'm2u3l4q7',
            type: 'fill',
          ...
          practiceQuestions: [
            {
              ...
              answer: '78千克',
              hint: '85-35+28=？',
              explanation: '85-35=50，50+28=78千克。'
            },
            {
            id: 'm2u3l5q2',
            type: 'fill',
          ...
          },
            {
              ...
              answer: '57本',
              hint: '80-38+15=？',
              explanation: '80-38=42，42+15=57本。'
            },
            {
              id: 'm2u3l5q6',
              type: 'choice',
    ...
    lessons: [
      {
        ...
        title: '乘法的意义',
        order: 1,
        teachingMethod: 'CPA实物分组→图示重复加→符号乘法',
        iDo: '家长用3盘苹果，每盘4个，演示4+4+4=12，写成3×4=12。',
        weDo: '亲子一起用积木分组，把加法算式改写成乘法算式。',
        youDo: '孩子独立把相同加数的加法改写成乘法算式。',
        parentTips: '乘法就是求几个相同加数的和的简便运算，关键是"相同加数"。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '3×5',
            hint: '3个5相加',
            explanation: '5+5+5是3个5相加，写成乘法就是3×5=15。'
          },
          {
            id: 'm2u4l1q2',
            type: 'fill',
            ...
            answer: '6',
            hint: '乘号前面是组数还是每组的数？',
            explanation: '4×6表示6个4相加，即4+4+4+4+4+4=24。'
          },
          {
            id: 'm2u4l1q3',
            type: 'flashcard',
            ...
            answer: '4×3=12',
            hint: '几组？每组几个？',
            explanation: '4组，每组3个，乘法算式4×3=12。'
          }
        ,
          {
            id: 'm2u4l1q4',
          ...
          },
          {
            ...
            answer: '3',
            hint: '5×3表示3个5或5个3。',
            explanation: '5×3表示3个5相加，即5+5+5=15。'
          },
          {
            id: 'm2u4l1q6',
            type: 'choice',
          ...
          },
          {
            ...
            explanation: '20+20+20=60，3个20相加等于60。'
          }
        ]
      },
      {
        ...
        title: '2-5的乘法口诀',
        order: 2,
        teachingMethod: 'I Do→We Do→You Do，口诀歌谣法',
        iDo: '家长带读2-5的乘法口诀，配合节奏拍手朗读。',
        weDo: '亲子一起拍手念口诀，互相考问答。',
        youDo: '孩子独立背诵2-5的乘法口诀并计算。',
        parentTips: '口诀要反复朗读，先理解再记忆，可以编成歌谣。',
      ...
      },
      {
        ...
        title: '6-9的乘法口诀',
        order: 3,
        teachingMethod: 'CPA手指辅助→口诀规律→速记法',
        iDo: '家长教9的乘法手指速算法，展示手指弯曲技巧。',
        weDo: '亲子一起用手指速算法练习9的乘法，互相考。',
        youDo: '孩子独立背诵6-9的乘法口诀并计算。',
        parentTips: '9的口诀有规律：积的十位和个位之和都是9，如18(1+8=9)。',
        ...
        ,
          ...
          },
          {
            ...
            answer: '48',
            hint: '6×7+6=6×8=48。',
            explanation: '6个7再加1个6等于8个6，6×8=48。'
          },
          {
            id: 'm2u4l3q6',
            type: 'choice',
          ...
          practiceQuestions: [
            {
              ...
              answer: '18和18',
              hint: '乘法交换律',
              explanation: '3×6=18，6×3=18，结果相同。'
            },
            {
            id: 'm2u4l4q2',
            type: 'fill',
    ...
    lessons: [
      {
        ...
        title: '平均分',
        order: 1,
        teachingMethod: 'CPA实物分配→图示均分→概念理解',
        iDo: '家长把12颗糖平均分给3个小朋友，每人数一数分到几颗。',
        weDo: '亲子一起用积木做平均分游戏，确保每份一样多。',
        youDo: '孩子独立把物品平均分成若干份。',
        parentTips: '平均分就是每份一样多，分完后要检查每份是否相同。',
      ...
      },
      {
        ...
        title: '除法的意义',
        order: 2,
        teachingMethod: 'I Do→We Do→You Do，乘除对照法',
        iDo: '家长讲解：12÷3=4，表示把12平均分成3份，每份是4。',
        weDo: '亲子一起把平均分的过程写成除法算式，和乘法对照。',
        youDo: '孩子独立写出除法算式，理解被除数、除数、商。',
        parentTips: '除法是乘法的逆运算，想乘法可以算除法。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '15',
            hint: '被除数是除号前面的数',
            explanation: '在15÷5=3中，15是被除数，5是除数，3是商。'
          },
          {
            id: 'm2u5l2q2',
            type: 'fill',
      ...
      },
      {
        ...
        title: '用乘法口诀求商',
        order: 3,
        teachingMethod: 'CPA口诀逆推→图示对照→符号速算',
        iDo: '家长示范：24÷6=？想6的口诀，四六二十四，所以商是4。',
        weDo: '亲子一起用乘法口诀快速求商，互相考。',
        youDo: '孩子独立用乘法口诀求商。',
        parentTips: '想口诀求商最快：看除数想口诀，找到被除数对应的那个数就是商。',
        ...
        ,
          {
            ...
            type: 'choice',
            question: '下面哪个算式的商是6？',
            options: ["12÷2","24÷4","30÷6","36÷6"],
            answer: '12÷2',
            hint: '分别计算每个算式',
            explanation: '12÷2=6，24÷4=6，30÷6=5，36÷6=6。12÷2和24÷4和36÷6的商都是6，但12÷2是第一个选项。'
          },
          {
            id: 'm2u5l3q5',
            type: 'fill',
    ...
    lessons: [
      {
        ...
        title: '认识角',
        order: 1,
        teachingMethod: 'CPA实物找角→图示画角→符号标记',
        iDo: '家长用三角板指出角，讲解角有一个顶点和两条边。',
        weDo: '亲子一起在教室里找角，指出每个角的顶点和边。',
        youDo: '孩子独立识别图形中的角，标出顶点和边。',
        parentTips: '角有一个顶点和两条边，边是射线，可以无限延伸。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '一个顶点和两条边',
            hint: '角最关键的部分是什么？',
            explanation: '角由一个顶点和从顶点出发的两条边组成。'
          },
          {
            id: 'm2u6l1q2',
            type: 'fill',
      ...
      },
      {
        ...
        title: '直角锐角钝角',
        order: 2,
        teachingMethod: 'I Do→We Do→You Do，三角板比对法',
        iDo: '家长用三角板的直角比对不同角，讲解直角、锐角、钝角。',
        weDo: '亲子一起用三角板判断角的类型，分类摆放。',
        youDo: '孩子独立判断角是直角、锐角还是钝角。',
        parentTips: '用三角板的直角去比，比直角小是锐角，比直角大是钝角。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '锐角',
            hint: '比直角"小"就是"锐"',
            explanation: '比直角小的角叫锐角，锐就是尖锐的意思。'
          },
          {
            id: 'm2u6l2q2',
            type: 'fill',
            ...
            answer: '直',
            hint: '用三角板比一比',
            explanation: '长方形的4个角都是直角，每个角都是90度。'
          },
          {
            id: 'm2u6l2q3',
            type: 'flashcard',
      ...
      },
      {
        ...
        title: '画角',
        order: 3,
        teachingMethod: 'CPA实物画角→图示步骤→独立操作',
        iDo: '家长示范画角的步骤：先画顶点，再从顶点画两条边。',
        weDo: '亲子一起画不同类型的角，互相检查。',
        youDo: '孩子独立画直角、锐角和钝角。',
        parentTips: '画角时先确定顶点位置，再用尺子从顶点画两条边。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '画顶点',
            hint: '角从哪里开始？',
            explanation: '画角的第一步是确定顶点，然后从顶点画两条边。'
          },
          {
            id: 'm2u6l3q2',
            type: 'fill',
        ...
        ,
          ...
          },
          {
            ...
            answer: '大',
            hint: '直角90度大于锐角。',
            explanation: '直角90度大于锐角，所以直角比锐角大。'
          },
          {
            id: 'm2u6l3q6',
            type: 'choice',
        ...
        },
        {
          ...
          practiceQuestions: [
          ...
          },
            {
              ...
              answer: '直角',
              hint: '三角板上有一个方方正正的角',
              explanation: '三角板上最大的角是直角，可以用来辨认直角。'
            },
            {
              id: 'm2u6l5q6',
              type: 'choice',
    ...
    lessons: [
      {
        ...
        title: '分类整理',
        order: 1,
        teachingMethod: 'CPA实物分类→图示归类→表格记录',
        iDo: '家长把一堆混合的积木按颜色分类，示范分类方法。',
        weDo: '亲子一起把家里的物品按不同标准分类，记录每类的数量。',
        youDo: '孩子独立对物品进行分类并记录结果。',
        parentTips: '分类要先确定标准，如按颜色、形状、大小等。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '红色类',
            hint: '分类标准是颜色',
            explanation: '按颜色分类时，红苹果和红草莓都是红色，分到红色类。'
          },
          {
            id: 'm2u7l1q2',
            type: 'fill',
          ...
          },
          {
            ...
            answer: '3',
            hint: '数一数有几种形状',
            explanation: '有圆形、三角形、正方形3种形状，分3类。'
          }
        ,
          {
            id: 'm2u7l1q4',
          ...
          },
          {
            ...
            answer: '5',
            hint: '一个正字5笔代表5。',
            explanation: '一个"正"字有5笔，每笔代表1个，所以每个"正"字代表5。'
          },
          {
            id: 'm2u7l1q6',
            type: 'choice',
          ...
          },
          {
            ...
            explanation: '一一对应比较时没有剩余，说明两种物品数量一样多。'
          }
        ]
      },
      {
        ...
        title: '简单统计表',
        order: 2,
        teachingMethod: 'I Do→We Do→You Do，表格制作法',
        iDo: '家长示范把分类结果填入统计表，讲解表格的行和列。',
        weDo: '亲子一起调查班级同学喜欢的颜色，制作统计表。',
        youDo: '孩子独立收集数据并制作简单统计表。',
        parentTips: '统计表要写清类别和数量，数据要准确。',
        ...
        practiceQuestions: [
          ...
          },
          {
            ...
            answer: '红色',
            hint: '看哪个数字最大',
            explanation: '统计表中数量最多的就是最受欢迎的，红色8人最多。'
          }
        ,
          {
            id: 'm2u7l2q4',
          ...
          },
          {
            ...
            answer: '18人',
            hint: '先算篮球再算跳绳',
            explanation: '篮球12-3=9人，跳绳9×2=18人。'
          },
          {
            id: 'm2u7l2q7',
            type: 'fill',
      ...
      },
      {
        ...
        title: '条形统计图',
        order: 3,
        teachingMethod: 'CPA实物摆图→图示画条→符号分析',
        iDo: '家长示范用方块摆出条形统计图，讲解横轴和纵轴。',
        weDo: '亲子一起把统计表的数据画成条形统计图。',
        youDo: '孩子独立根据数据绘制简单条形统计图。',
        parentTips: '条形统计图能直观看出谁多谁少，每格代表几个要标清楚。',
        ...
        practiceQuestions: [
          ...
          },
          {
            ...
            answer: '绿色',
            hint: '看哪根柱子最矮',
            explanation: '条形统计图中，柱子最矮的代表数量最少，绿色4人最少。'
          }
        ,
          {
            id: 'm2u7l3q4',
          ...
          },
          {
            ...
            answer: '75本；25本',
            hint: '先求总和再平均',
            explanation: '25+30+20=75，75÷3=25本/天。'
          },
          {
            id: 'm2u7l3q7',
            type: 'fill',
            ...
            answer: '12',
            hint: '[位置]（数学-位置-第1课）5+5+2=12人。',
            explanation: '每个"正"字5笔，两个"正"字10笔，加"一"2笔，共12人。'
          }
        ]
      }
    ,
    ...
    lessons: [
      {
        ...
        title: '简单排列',
        order: 1,
        teachingMethod: 'CPA实物操作→图示列举→符号记录',
        iDo: '家长用3张数字卡片1、2、3，示范摆出所有两位数：12、13、21、23、31、32。',
        weDo: '亲子一起用数字卡片摆不同的数，做到不重复不遗漏。',
        youDo: '孩子独立用给定数字摆出所有可能的排列。',
        parentTips: '排列要按顺序来，先固定一个数字再换其他，避免遗漏。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '2个',
            hint: '12和21',
            explanation: '用1和2可以摆出12和21两个不同的两位数。'
          },
          {
            id: 'm2u8l1q2',
            type: 'fill',
            ...
            answer: '6',
            hint: '固定十位再换个位',
            explanation: '十位1：12、13；十位2：21、23；十位3：31、32，共6个。'
          },
          {
            id: 'm2u8l1q3',
            type: 'flashcard',
            ...
            answer: '25和52',
            hint: '先2在十位，再5在十位',
            explanation: '用2和5可以摆出25和52两个两位数。'
          }
        ,
          {
            id: 'm2u8l1q4',
          ...
          },
          {
            ...
            answer: '6个',
            hint: '排列组合',
            explanation: '12、13、21、23、31、32共6个。'
          },
          {
            id: 'm2u8l1q7',
            type: 'fill',
      ...
      },
      {
        ...
        title: '简单组合',
        order: 2,
        teachingMethod: 'I Do→We Do→You Do，连线法',
        iDo: '家长用3件上衣和2条裤子示范搭配，用连线法列出所有组合。',
        weDo: '亲子一起用连线法做搭配练习，数出组合总数。',
        youDo: '孩子独立用连线法计算组合数。',
        parentTips: '组合和排列不同，搭配问题中顺序不重要，1+2和2+1是同一种搭配。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '6种',
            hint: '2×3=？',
            explanation: '每件上衣配3条裤子，2件上衣就是2×3=6种搭配。'
          },
          {
            id: 'm2u8l2q2',
            type: 'fill',
            ...
            answer: '6',
            hint: '3×2=？',
            explanation: '每种饮料配2种点心，3种饮料就是3×2=6种搭配。'
          },
          {
            id: 'm2u8l2q3',
            type: 'flashcard',
            ...
            answer: '12',
            hint: '4×3=？',
            explanation: '每种主食配3种菜，4种主食就是4×3=12种搭配。'
          }
        ,
          {
            id: 'm2u8l2q4',
          ...
          },
          {
            ...
            explanation: '3种颜色选2种涂上下两层，3×2=6种不同涂法。'
          },
          {
            id: 'm2u8l2q6',
            type: 'choice',
      ...
      },
      {
        ...
        iDo: '家长出综合搭配题：3个小朋友拍照，有几种不同的站法？',
        weDo: '亲子一起解决生活中的排列组合问题，画图列举。',
        youDo: '孩子独立解决排列组合的综合应用题。',
        parentTips: '排列组合问题要有序思考，画图或连线帮助列举。',
        ...
        practiceQuestions: [
          {
            ...
            answer: '6种',
            hint: '固定第一个再排后面',
            explanation: '3×2×1=6种，3个小朋友有6种不同站法。'
          },
          {
            id: 'm2u8l3q2',
            type: 'fill',
            ...
            answer: '6',
            hint: '用连线法数一数',
            explanation: '4种颜色选2种，用连线法：4×3÷2=6种选法。'
          },
          {
            id: 'm2u8l3q3',
            type: 'flashcard',
            ...
            answer: '6',
            hint: '2×3=？',
            explanation: '每种面包配3种饮料，2种面包就是2×3=6种搭配。'
          }
        ,
          {
            id: 'm2u8l3q4',
          ...
          },
          {
            ...
            answer: '4',
            hint: '共4个。',
            explanation: '10、12、20、21共4个不同的两位数。'
          },
          {
            id: 'm2u8l3q6',
            type: 'choice',
            ...
            answer: '6场',
            hint: '组合问题',
            explanation: '4×3÷2=6场（每场比赛被两队各算1次要除以2）。'
          },
          {
            id: 'm2u8l3q7',
            type: 'fill',
    ...
    ,
        {
          ...
          practiceQuestions: [
            ...
            answer: '6',
            hint: '每个数字都能做十位',
            explanation: '24、25、42、45、52、54共6个。'
          },
            {
              id: 'm2u8l4q3',
              type: 'choice',
        ...
        },
        {
          ...
          practiceQuestions: [
            ...
            answer: '6',
            hint: '每个数字都能做百位',
            explanation: '123、132、213、231、312、321共6个。'
          },
            {
              id: 'm2u8l5q3',
              type: 'choice',
          ...
          },
            {
              ...
              answer: '6个',
              hint: '每个数字做十位有2种',
              explanation: '25、28、52、58、82、85共6个。'
            },
            {
              id: 'm2u8l5q6',
              type: 'choice',
